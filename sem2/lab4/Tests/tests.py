...
from core.Entities.Brakes import Brakes
from core.Entities.Car import Car
from core.Entities.Driver import Driver
from core.Entities.Engine import Engine
from core.Entities.Fuel import Fuel
from core.Entities.GasStation import GasStation
from core.Entities.Gastank import Gastank
from core.Entities.Lights import Lights
from core.Entities.Station import Station
from core.Entities.Transmission import Transmission
from core.Entities.Wheel import Wheel
from core.Exceptions.CarException import CarException
from core.Exceptions.DeficitException import DeficitException
from core.Exceptions.DifferentFuelException import DifferentFuelException
from core.Exceptions.FuelException import FuelException
from core.Utility.Menu import Menu
from core.Utility.SaveManager import SaveManager
...
class TestGasStation(unittest.TestCase):
    ...
    def test_overfill_raises_FuelException(self):
        with self.assertRaises(FuelException):
            self.station.fill_fuel(self.car, 60.0)  
...
class TestSaveManager(unittest.TestCase):
    def setUp(self):
        ...
        SaveManager.SAVE_FILE = self.save_path  
