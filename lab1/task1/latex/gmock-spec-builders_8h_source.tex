...
\hypertarget{gmock-spec-builders_8h_source}{}\label{gmock-spec-builders_8h_source}\index{googletest/googlemock/include/gmock/gmock-\/spec-\/builders.h@{googletest/googlemock/include/gmock/gmock-\/spec-\/builders.h}}
...
\DoxyCodeLine{01841\ \ \ \ \ \textcolor{keyword}{const}\ UninterestingCallCleanupHandler\ report\_uninteresting\_call\ =\ \{reaction,}
\DoxyCodeLine{01842\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ ss\};}
\DoxyCodeLine{01843\ }
\DoxyCodeLine{01844\ \ \ \ \ \textcolor{keywordflow}{return}\ PerformActionAndPrintResult(\textcolor{keyword}{nullptr},\ std::move(args),\ ss.str(),\ ss);}
\DoxyCodeLine{01845\ \ \ \}}
\DoxyCodeLine{01846\ }
\DoxyCodeLine{01847\ \ \ \textcolor{keywordtype}{bool}\ is\_excessive\ =\ \textcolor{keyword}{false};}
\DoxyCodeLine{01848\ \ \ ::std::stringstream\ ss;}
\DoxyCodeLine{01849\ \ \ ::std::stringstream\ why;}
\DoxyCodeLine{01850\ \ \ ::std::stringstream\ loc;}
\DoxyCodeLine{01851\ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{void}*\ untyped\_action\ =\ \textcolor{keyword}{nullptr};}
\DoxyCodeLine{01852\ }
\DoxyCodeLine{01853\ \ \ \textcolor{comment}{//\ The\ UntypedFindMatchingExpectation()\ function\ acquires\ and}}
\DoxyCodeLine{01854\ \ \ \textcolor{comment}{//\ releases\ g\_gmock\_mutex.}}
\DoxyCodeLine{01855\ }
\DoxyCodeLine{01856\ \ \ \textcolor{keyword}{const}\ ExpectationBase*\ \textcolor{keyword}{const}\ untyped\_expectation\ =}
\DoxyCodeLine{01857\ \ \ \ \ \ \ this-\/>UntypedFindMatchingExpectation(\&args,\ \&untyped\_action,}
\DoxyCodeLine{01858\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \&is\_excessive,\ \&ss,\ \&why);}
\DoxyCodeLine{01859\ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{bool}\ found\ =\ untyped\_expectation\ !=\ \textcolor{keyword}{nullptr};}
\DoxyCodeLine{01860\ }
\DoxyCodeLine{01861\ \ \ \textcolor{comment}{//\ True\ if\ and\ only\ if\ we\ need\ to\ print\ the\ call's\ arguments}}
\DoxyCodeLine{01862\ \ \ \textcolor{comment}{//\ and\ return\ value.}}
\DoxyCodeLine{01863\ \ \ \textcolor{comment}{//\ This\ definition\ must\ be\ kept\ in\ sync\ with\ the\ uses\ of\ Expect()}}
\DoxyCodeLine{01864\ \ \ \textcolor{comment}{//\ and\ Log()\ in\ this\ function.}}
\DoxyCodeLine{01865\ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{bool}\ need\_to\_report\_call\ =}
\DoxyCodeLine{01866\ \ \ \ \ \ \ !found\ ||\ is\_excessive\ ||\ LogIsVisible(kInfo);}
\DoxyCodeLine{01867\ \ \ \textcolor{keywordflow}{if}\ (!need\_to\_report\_call)\ \{}
\DoxyCodeLine{01868\ \ \ \ \ \textcolor{comment}{//\ Perform\ the\ action\ without\ printing\ the\ call\ information.}}
\DoxyCodeLine{01869\ \ \ \ \ \textcolor{keywordflow}{return}\ PerformAction(untyped\_action,\ std::move(args),\ \textcolor{stringliteral}{"{}"{}});}
\DoxyCodeLine{01870\ \ \ \}}
\DoxyCodeLine{01871\ }
\DoxyCodeLine{01872\ \ \ ss\ <<\ \textcolor{stringliteral}{"{}\ \ \ \ Function\ call:\ "{}}\ <<\ Name();}
\DoxyCodeLine{01873\ \ \ this-\/>UntypedPrintArgs(\&args,\ \&ss);}
\DoxyCodeLine{01874\ }
\DoxyCodeLine{01875\ \ \ \textcolor{comment}{//\ In\ case\ the\ action\ deletes\ a\ piece\ of\ the\ expectation,\ we}}
\DoxyCodeLine{01876\ \ \ \textcolor{comment}{//\ generate\ the\ message\ beforehand.}}
\DoxyCodeLine{01877\ \ \ \textcolor{keywordflow}{if}\ (found\ \&\&\ !is\_excessive)\ \{}
\DoxyCodeLine{01878\ \ \ \ \ untyped\_expectation-\/>DescribeLocationTo(\&loc);}
\DoxyCodeLine{01879\ \ \ \}}
\DoxyCodeLine{01880\ }
\DoxyCodeLine{01881\ \ \ \textcolor{comment}{//\ Perform\ the\ action,\ print\ the\ result,\ and\ then\ fail\ or\ log\ in\ whatever\ way}}
\DoxyCodeLine{01882\ \ \ \textcolor{comment}{//\ is\ appropriate.}}
\DoxyCodeLine{01883\ \ \ \textcolor{comment}{//}}
\DoxyCodeLine{01884\ \ \ \textcolor{comment}{//\ We\ use\ RAII\ to\ do\ the\ latter\ in\ case\ R\ is\ void\ or\ a\ non-\/moveable\ type.\ In}}
\DoxyCodeLine{01885\ \ \ \textcolor{comment}{//\ either\ case\ we\ can't\ assign\ it\ to\ a\ local\ variable.}}
\DoxyCodeLine{01886\ \ \ \textcolor{comment}{//}}
\DoxyCodeLine{01887\ \ \ \textcolor{comment}{//\ Note\ that\ we\ *don't*\ use\ any\ local\ callback\ types\ (like\ lambdas)\ here.}}
\DoxyCodeLine{01888\ \ \ \textcolor{comment}{//\ Doing\ so\ slows\ down\ compilation\ dramatically\ because\ the\ *constructor*\ of}}
\DoxyCodeLine{01889\ \ \ \textcolor{comment}{//\ std::function<T>\ is\ re-\/instantiated\ with\ different\ template}}
\DoxyCodeLine{01890\ \ \ \textcolor{comment}{//\ parameters\ each\ time.}}
\DoxyCodeLine{01891\ \ \ \textcolor{keyword}{const}\ FailureCleanupHandler\ handle\_failures\ =\ \{}
\DoxyCodeLine{01892\ \ \ \ \ \ \ ss,\ why,\ loc,\ untyped\_expectation,\ found,\ is\_excessive\};}
\DoxyCodeLine{01893\ }
\DoxyCodeLine{01894\ \ \ \textcolor{keywordflow}{return}\ PerformActionAndPrintResult(untyped\_action,\ std::move(args),\ ss.str(),}
\DoxyCodeLine{01895\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ ss);}
\DoxyCodeLine{01896\ \}}
\DoxyCodeLine{01897\ }
\DoxyCodeLine{01898\ \}\ \ \textcolor{comment}{//\ namespace\ internal}}
\DoxyCodeLine{01899\ }
\DoxyCodeLine{01900\ \textcolor{keyword}{namespace\ }internal\ \{}
\DoxyCodeLine{01901\ }
\DoxyCodeLine{01902\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ F>}
\DoxyCodeLine{01903\ \textcolor{keyword}{class\ }MockFunction;}
\DoxyCodeLine{01904\ }
\DoxyCodeLine{01905\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ R,\ \textcolor{keyword}{typename}...\ Args>}
\DoxyCodeLine{01906\ \textcolor{keyword}{class\ }MockFunction<R(Args...)>\ \{}
\DoxyCodeLine{01907\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{01908\ \ \ MockFunction(\textcolor{keyword}{const}\ MockFunction\&)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{01909\ \ \ MockFunction\&\ operator=(\textcolor{keyword}{const}\ MockFunction\&)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{01910\ }
\DoxyCodeLine{01911\ \ \ std::function<R(Args...)>\ AsStdFunction()\ \{}
\DoxyCodeLine{01912\ \ \ \ \ \textcolor{keywordflow}{return}\ [\textcolor{keyword}{this}](Args...\ args)\ -\/>\ R\ \{}
\DoxyCodeLine{01913\ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ this-\/>Call(std::forward<Args>(args)...);}
\DoxyCodeLine{01914\ \ \ \ \ \};}
\DoxyCodeLine{01915\ \ \ \}}
\DoxyCodeLine{01916\ }
\DoxyCodeLine{01917\ \ \ \textcolor{comment}{//\ Implementation\ detail:\ the\ expansion\ of\ the\ MOCK\_METHOD\ macro.}}
\DoxyCodeLine{01918\ \ \ R\ Call(Args...\ args)\ \{}
\DoxyCodeLine{01919\ \ \ \ \ mock\_.SetOwnerAndName(\textcolor{keyword}{this},\ \textcolor{stringliteral}{"{}Call"{}});}
\DoxyCodeLine{01920\ \ \ \ \ \textcolor{keywordflow}{return}\ mock\_.Invoke(std::forward<Args>(args)...);}
\DoxyCodeLine{01921\ \ \ \}}
\DoxyCodeLine{01922\ }
\DoxyCodeLine{01923\ \ \ MockSpec<R(Args...)>\ gmock\_Call(Matcher<Args>...\ m)\ \{}
\DoxyCodeLine{01924\ \ \ \ \ mock\_.RegisterOwner(\textcolor{keyword}{this});}
\DoxyCodeLine{01925\ \ \ \ \ \textcolor{keywordflow}{return}\ mock\_.With(std::move(m)...);}
\DoxyCodeLine{01926\ \ \ \}}
\DoxyCodeLine{01927\ }
\DoxyCodeLine{01928\ \ \ MockSpec<R(Args...)>\ gmock\_Call(\textcolor{keyword}{const}\ WithoutMatchers\&,\ R\ (*)(Args...))\ \{}
\DoxyCodeLine{01929\ \ \ \ \ \textcolor{keywordflow}{return}\ this-\/>gmock\_Call(::testing::A<Args>()...);}
\DoxyCodeLine{01930\ \ \ \}}
\DoxyCodeLine{01931\ }
\DoxyCodeLine{01932\ \ \textcolor{keyword}{protected}:}
\DoxyCodeLine{01933\ \ \ MockFunction()\ =\ \textcolor{keywordflow}{default};}
\DoxyCodeLine{01934\ \ \ \string~MockFunction()\ =\ \textcolor{keywordflow}{default};}
\DoxyCodeLine{01935\ }
\DoxyCodeLine{01936\ \ \textcolor{keyword}{private}:}
\DoxyCodeLine{01937\ \ \ FunctionMocker<R(Args...)>\ mock\_;}
\DoxyCodeLine{01938\ \};}
\DoxyCodeLine{01939\ }
\DoxyCodeLine{01940\ \textcolor{comment}{/*}}
\DoxyCodeLine{01941\ \textcolor{comment}{The\ SignatureOf<F>\ struct\ is\ a\ meta-\/function\ returning\ function\ signature}}
\DoxyCodeLine{01942\ \textcolor{comment}{corresponding\ to\ the\ provided\ F\ argument.}}
\DoxyCodeLine{01943\ \textcolor{comment}{}}
\DoxyCodeLine{01944\ \textcolor{comment}{It\ makes\ use\ of\ MockFunction\ easier\ by\ allowing\ it\ to\ accept\ more\ F\ arguments}}
\DoxyCodeLine{01945\ \textcolor{comment}{than\ just\ function\ signatures.}}
\DoxyCodeLine{01946\ \textcolor{comment}{}}
\DoxyCodeLine{01947\ \textcolor{comment}{Specializations\ provided\ here\ cover\ a\ signature\ type\ itself\ and\ any\ template}}
\DoxyCodeLine{01948\ \textcolor{comment}{that\ can\ be\ parameterized\ with\ a\ signature,\ including\ std::function\ and}}
\DoxyCodeLine{01949\ \textcolor{comment}{boost::function.}}
\DoxyCodeLine{01950\ \textcolor{comment}{*/}}
\DoxyCodeLine{01951\ }
\DoxyCodeLine{01952\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ F,\ \textcolor{keyword}{typename}\ =\ \textcolor{keywordtype}{void}>}
\DoxyCodeLine{01953\ \textcolor{keyword}{struct\ }SignatureOf;}
\DoxyCodeLine{01954\ }
\DoxyCodeLine{01955\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ R,\ \textcolor{keyword}{typename}...\ Args>}
\DoxyCodeLine{01956\ \textcolor{keyword}{struct\ }SignatureOf<R(Args...)>\ \{}
\DoxyCodeLine{01957\ \ \ \textcolor{keyword}{using\ }type\ =\ R(Args...);}
\DoxyCodeLine{01958\ \};}
\DoxyCodeLine{01959\ }
\DoxyCodeLine{01960\ \textcolor{keyword}{template}\ <\textcolor{keyword}{template}\ <\textcolor{keyword}{typename}>\ \textcolor{keyword}{class\ }C,\ \textcolor{keyword}{typename}\ F>}
\DoxyCodeLine{01961\ \textcolor{keyword}{struct\ }SignatureOf<C<F>,}
\DoxyCodeLine{01962\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ typename\ std::enable\_if<std::is\_function<F>::value>::type>}
\DoxyCodeLine{01963\ \ \ \ \ :\ SignatureOf<F>\ \{\};}
\DoxyCodeLine{01964\ }
\DoxyCodeLine{01965\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ F>}
\DoxyCodeLine{01966\ \textcolor{keyword}{using\ }SignatureOfT\ =\ \textcolor{keyword}{typename}\ SignatureOf<F>::type;}
\DoxyCodeLine{01967\ }
\DoxyCodeLine{01968\ \}\ \ \textcolor{comment}{//\ namespace\ internal}}
\DoxyCodeLine{01969\ }
\DoxyCodeLine{01970\ \textcolor{comment}{//\ A\ MockFunction<F>\ type\ has\ one\ mock\ method\ whose\ type\ is}}
\DoxyCodeLine{01971\ \textcolor{comment}{//\ internal::SignatureOfT<F>.\ \ It\ is\ useful\ when\ you\ just\ want\ your}}
\DoxyCodeLine{01972\ \textcolor{comment}{//\ test\ code\ to\ emit\ some\ messages\ and\ have\ Google\ Mock\ verify\ the}}
\DoxyCodeLine{01973\ \textcolor{comment}{//\ right\ messages\ are\ sent\ (and\ perhaps\ at\ the\ right\ times).\ \ For}}
\DoxyCodeLine{01974\ \textcolor{comment}{//\ example,\ if\ you\ are\ exercising\ code:}}
\DoxyCodeLine{01975\ \textcolor{comment}{//}}
\DoxyCodeLine{01976\ \textcolor{comment}{//\ \ \ Foo(1);}}
\DoxyCodeLine{01977\ \textcolor{comment}{//\ \ \ Foo(2);}}
\DoxyCodeLine{01978\ \textcolor{comment}{//\ \ \ Foo(3);}}
\DoxyCodeLine{01979\ \textcolor{comment}{//}}
\DoxyCodeLine{01980\ \textcolor{comment}{//\ and\ want\ to\ verify\ that\ Foo(1)\ and\ Foo(3)\ both\ invoke}}
\DoxyCodeLine{01981\ \textcolor{comment}{//\ mock.Bar("{}a"{}),\ but\ Foo(2)\ doesn't\ invoke\ anything,\ you\ can\ write:}}
\DoxyCodeLine{01982\ \textcolor{comment}{//}}
\DoxyCodeLine{01983\ \textcolor{comment}{//\ TEST(FooTest,\ InvokesBarCorrectly)\ \{}}
\DoxyCodeLine{01984\ \textcolor{comment}{//\ \ \ MyMock\ mock;}}
\DoxyCodeLine{01985\ \textcolor{comment}{//\ \ \ MockFunction<void(string\ check\_point\_name)>\ check;}}
\DoxyCodeLine{01986\ \textcolor{comment}{//\ \ \ \{}}
\DoxyCodeLine{01987\ \textcolor{comment}{//\ \ \ \ \ InSequence\ s;}}
\DoxyCodeLine{01988\ \textcolor{comment}{//}}
\DoxyCodeLine{01989\ \textcolor{comment}{//\ \ \ \ \ EXPECT\_CALL(mock,\ Bar("{}a"{}));}}
\DoxyCodeLine{01990\ \textcolor{comment}{//\ \ \ \ \ EXPECT\_CALL(check,\ Call("{}1"{}));}}
\DoxyCodeLine{01991\ \textcolor{comment}{//\ \ \ \ \ EXPECT\_CALL(check,\ Call("{}2"{}));}}
\DoxyCodeLine{01992\ \textcolor{comment}{//\ \ \ \ \ EXPECT\_CALL(mock,\ Bar("{}a"{}));}}
\DoxyCodeLine{01993\ \textcolor{comment}{//\ \ \ \}}}
\DoxyCodeLine{01994\ \textcolor{comment}{//\ \ \ Foo(1);}}
\DoxyCodeLine{01995\ \textcolor{comment}{//\ \ \ check.Call("{}1"{});}}
\DoxyCodeLine{01996\ \textcolor{comment}{//\ \ \ Foo(2);}}
\DoxyCodeLine{01997\ \textcolor{comment}{//\ \ \ check.Call("{}2"{});}}
\DoxyCodeLine{01998\ \textcolor{comment}{//\ \ \ Foo(3);}}
\DoxyCodeLine{01999\ \textcolor{comment}{//\ \}}}
\DoxyCodeLine{02000\ \textcolor{comment}{//}}
\DoxyCodeLine{02001\ \textcolor{comment}{//\ The\ expectation\ spec\ says\ that\ the\ first\ Bar("{}a"{})\ must\ happen}}
\DoxyCodeLine{02002\ \textcolor{comment}{//\ before\ check\ point\ "{}1"{},\ the\ second\ Bar("{}a"{})\ must\ happen\ after\ check}}
\DoxyCodeLine{02003\ \textcolor{comment}{//\ point\ "{}2"{},\ and\ nothing\ should\ happen\ between\ the\ two\ check}}
\DoxyCodeLine{02004\ \textcolor{comment}{//\ points.\ The\ explicit\ check\ points\ make\ it\ easy\ to\ tell\ which}}
\DoxyCodeLine{02005\ \textcolor{comment}{//\ Bar("{}a"{})\ is\ called\ by\ which\ call\ to\ Foo().}}
\DoxyCodeLine{02006\ \textcolor{comment}{//}}
\DoxyCodeLine{02007\ \textcolor{comment}{//\ MockFunction<F>\ can\ also\ be\ used\ to\ exercise\ code\ that\ accepts}}
\DoxyCodeLine{02008\ \textcolor{comment}{//\ std::function<internal::SignatureOfT<F>>\ callbacks.\ To\ do\ so,\ use}}
\DoxyCodeLine{02009\ \textcolor{comment}{//\ AsStdFunction()\ method\ to\ create\ std::function\ proxy\ forwarding\ to}}
\DoxyCodeLine{02010\ \textcolor{comment}{//\ original\ object's\ Call.\ Example:}}
\DoxyCodeLine{02011\ \textcolor{comment}{//}}
\DoxyCodeLine{02012\ \textcolor{comment}{//\ TEST(FooTest,\ RunsCallbackWithBarArgument)\ \{}}
\DoxyCodeLine{02013\ \textcolor{comment}{//\ \ \ MockFunction<int(string)>\ callback;}}
\DoxyCodeLine{02014\ \textcolor{comment}{//\ \ \ EXPECT\_CALL(callback,\ Call("{}bar"{})).WillOnce(Return(1));}}
\DoxyCodeLine{02015\ \textcolor{comment}{//\ \ \ Foo(callback.AsStdFunction());}}
\DoxyCodeLine{02016\ \textcolor{comment}{//\ \}}}
\DoxyCodeLine{02017\ \textcolor{comment}{//}}
\DoxyCodeLine{02018\ \textcolor{comment}{//\ The\ internal::SignatureOfT<F>\ indirection\ allows\ to\ use\ other\ types}}
\DoxyCodeLine{02019\ \textcolor{comment}{//\ than\ just\ function\ signature\ type.\ This\ is\ typically\ useful\ when}}
\DoxyCodeLine{02020\ \textcolor{comment}{//\ providing\ a\ mock\ for\ a\ predefined\ std::function\ type.\ Example:}}
\DoxyCodeLine{02021\ \textcolor{comment}{//}}
\DoxyCodeLine{02022\ \textcolor{comment}{//\ using\ FilterPredicate\ =\ std::function<bool(string)>;}}
\DoxyCodeLine{02023\ \textcolor{comment}{//\ void\ MyFilterAlgorithm(FilterPredicate\ predicate);}}
\DoxyCodeLine{02024\ \textcolor{comment}{//}}
\DoxyCodeLine{02025\ \textcolor{comment}{//\ TEST(FooTest,\ FilterPredicateAlwaysAccepts)\ \{}}
\DoxyCodeLine{02026\ \textcolor{comment}{//\ \ \ MockFunction<FilterPredicate>\ predicateMock;}}
\DoxyCodeLine{02027\ \textcolor{comment}{//\ \ \ EXPECT\_CALL(predicateMock,\ Call(\_)).WillRepeatedly(Return(true));}}
\DoxyCodeLine{02028\ \textcolor{comment}{//\ \ \ MyFilterAlgorithm(predicateMock.AsStdFunction());}}
\DoxyCodeLine{02029\ \textcolor{comment}{//\ \}}}
\DoxyCodeLine{02030\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ F>}
\DoxyCodeLine{02031\ \textcolor{keyword}{class\ }MockFunction\ :\ \textcolor{keyword}{public}\ internal::MockFunction<internal::SignatureOfT<F>>\ \{}
\DoxyCodeLine{02032\ \ \ \textcolor{keyword}{using\ }\mbox{\hyperlink{classBase}{Base}}\ =\ internal::MockFunction<internal::SignatureOfT<F>>;}
\DoxyCodeLine{02033\ }
\DoxyCodeLine{02034\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{02035\ \ \ \textcolor{keyword}{using\ }Base::Base;}
\DoxyCodeLine{02036\ \};}
\DoxyCodeLine{02037\ }
\DoxyCodeLine{02038\ \textcolor{comment}{//\ The\ style\ guide\ prohibits\ "{}using"{}\ statements\ in\ a\ namespace\ scope}}
\DoxyCodeLine{02039\ \textcolor{comment}{//\ inside\ a\ header\ file.\ \ However,\ the\ MockSpec\ class\ template\ is}}
\DoxyCodeLine{02040\ \textcolor{comment}{//\ meant\ to\ be\ defined\ in\ the\ ::testing\ namespace.\ \ The\ following\ line}}
\DoxyCodeLine{02041\ \textcolor{comment}{//\ is\ just\ a\ trick\ for\ working\ around\ a\ bug\ in\ MSVC\ 8.0,\ which\ cannot}}
\DoxyCodeLine{02042\ \textcolor{comment}{//\ handle\ it\ if\ we\ define\ MockSpec\ in\ ::testing.}}
\DoxyCodeLine{02043\ \textcolor{keyword}{using\ }internal::MockSpec;}
\DoxyCodeLine{02044\ }
\DoxyCodeLine{02045\ \textcolor{comment}{//\ Const(x)\ is\ a\ convenient\ function\ for\ obtaining\ a\ const\ reference}}
\DoxyCodeLine{02046\ \textcolor{comment}{//\ to\ x.\ \ This\ is\ useful\ for\ setting\ expectations\ on\ an\ overloaded}}
\DoxyCodeLine{02047\ \textcolor{comment}{//\ const\ mock\ method,\ e.g.}}
\DoxyCodeLine{02048\ \textcolor{comment}{//}}
\DoxyCodeLine{02049\ \textcolor{comment}{//\ \ \ class\ MockFoo\ :\ public\ FooInterface\ \{}}
\DoxyCodeLine{02050\ \textcolor{comment}{//\ \ \ \ public:}}
\DoxyCodeLine{02051\ \textcolor{comment}{//\ \ \ \ \ MOCK\_METHOD0(Bar,\ int());}}
\DoxyCodeLine{02052\ \textcolor{comment}{//\ \ \ \ \ MOCK\_CONST\_METHOD0(Bar,\ int\&());}}
\DoxyCodeLine{02053\ \textcolor{comment}{//\ \ \ \};}}
\DoxyCodeLine{02054\ \textcolor{comment}{//}}
\DoxyCodeLine{02055\ \textcolor{comment}{//\ \ \ MockFoo\ foo;}}
\DoxyCodeLine{02056\ \textcolor{comment}{//\ \ \ //\ Expects\ a\ call\ to\ non-\/const\ MockFoo::Bar().}}
\DoxyCodeLine{02057\ \textcolor{comment}{//\ \ \ EXPECT\_CALL(foo,\ Bar());}}
\DoxyCodeLine{02058\ \textcolor{comment}{//\ \ \ //\ Expects\ a\ call\ to\ const\ MockFoo::Bar().}}
\DoxyCodeLine{02059\ \textcolor{comment}{//\ \ \ EXPECT\_CALL(Const(foo),\ Bar());}}
\DoxyCodeLine{02060\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{02061\ \textcolor{keyword}{inline}\ \textcolor{keyword}{const}\ T\&\ Const(\textcolor{keyword}{const}\ T\&\ x)\ \{}
\DoxyCodeLine{02062\ \ \ \textcolor{keywordflow}{return}\ x;}
\DoxyCodeLine{02063\ \}}
\DoxyCodeLine{02064\ }
\DoxyCodeLine{02065\ \textcolor{comment}{//\ Constructs\ an\ Expectation\ object\ that\ references\ and\ co-\/owns\ exp.}}
\DoxyCodeLine{02066\ \textcolor{keyword}{inline}\ Expectation::Expectation(internal::ExpectationBase\&\ exp)\ \ \textcolor{comment}{//\ NOLINT}}
\DoxyCodeLine{02067\ \ \ \ \ :\ expectation\_base\_(exp.GetHandle().expectation\_base())\ \{\}}
\DoxyCodeLine{02068\ }
\DoxyCodeLine{02069\ \}\ \ \textcolor{comment}{//\ namespace\ testing}}
\DoxyCodeLine{02070\ }
\DoxyCodeLine{02071\ GTEST\_DISABLE\_MSC\_WARNINGS\_POP\_()\ \ \textcolor{comment}{//\ \ 4251}}
\DoxyCodeLine{02072\ }
\DoxyCodeLine{02073\ \textcolor{comment}{//\ Implementation\ for\ ON\_CALL\ and\ EXPECT\_CALL\ macros.\ A\ separate\ macro\ is}}
\DoxyCodeLine{02074\ \textcolor{comment}{//\ required\ to\ avoid\ compile\ errors\ when\ the\ name\ of\ the\ method\ used\ in\ call\ is}}
\DoxyCodeLine{02075\ \textcolor{comment}{//\ a\ result\ of\ macro\ expansion.\ See\ CompilesWithMethodNameExpandedFromMacro}}
\DoxyCodeLine{02076\ \textcolor{comment}{//\ tests\ in\ internal/gmock-\/spec-\/builders\_test.cc\ for\ more\ details.}}
\DoxyCodeLine{02077\ \textcolor{comment}{//}}
\DoxyCodeLine{02078\ \textcolor{comment}{//\ This\ macro\ supports\ statements\ both\ with\ and\ without\ parameter\ matchers.\ If}}
\DoxyCodeLine{02079\ \textcolor{comment}{//\ the\ parameter\ list\ is\ omitted,\ gMock\ will\ accept\ any\ parameters,\ which\ allows}}
\DoxyCodeLine{02080\ \textcolor{comment}{//\ tests\ to\ be\ written\ that\ don't\ need\ to\ encode\ the\ number\ of\ method}}
\DoxyCodeLine{02081\ \textcolor{comment}{//\ parameter.\ This\ technique\ may\ only\ be\ used\ for\ non-\/overloaded\ methods.}}
\DoxyCodeLine{02082\ \textcolor{comment}{//}}
\DoxyCodeLine{02083\ \textcolor{comment}{//\ \ \ //\ These\ are\ the\ same:}}
\DoxyCodeLine{02084\ \textcolor{comment}{//\ \ \ ON\_CALL(mock,\ NoArgsMethod()).WillByDefault(...);}}
\DoxyCodeLine{02085\ \textcolor{comment}{//\ \ \ ON\_CALL(mock,\ NoArgsMethod).WillByDefault(...);}}
\DoxyCodeLine{02086\ \textcolor{comment}{//}}
\DoxyCodeLine{02087\ \textcolor{comment}{//\ \ \ //\ As\ are\ these:}}
\DoxyCodeLine{02088\ \textcolor{comment}{//\ \ \ ON\_CALL(mock,\ TwoArgsMethod(\_,\ \_)).WillByDefault(...);}}
\DoxyCodeLine{02089\ \textcolor{comment}{//\ \ \ ON\_CALL(mock,\ TwoArgsMethod).WillByDefault(...);}}
\DoxyCodeLine{02090\ \textcolor{comment}{//}}
\DoxyCodeLine{02091\ \textcolor{comment}{//\ \ \ //\ Can\ also\ specify\ args\ if\ you\ want,\ of\ course:}}
\DoxyCodeLine{02092\ \textcolor{comment}{//\ \ \ ON\_CALL(mock,\ TwoArgsMethod(\_,\ 45)).WillByDefault(...);}}
\DoxyCodeLine{02093\ \textcolor{comment}{//}}
\DoxyCodeLine{02094\ \textcolor{comment}{//\ \ \ //\ Overloads\ work\ as\ long\ as\ you\ specify\ parameters:}}
\DoxyCodeLine{02095\ \textcolor{comment}{//\ \ \ ON\_CALL(mock,\ OverloadedMethod(\_)).WillByDefault(...);}}
\DoxyCodeLine{02096\ \textcolor{comment}{//\ \ \ ON\_CALL(mock,\ OverloadedMethod(\_,\ \_)).WillByDefault(...);}}
\DoxyCodeLine{02097\ \textcolor{comment}{//}}
\DoxyCodeLine{02098\ \textcolor{comment}{//\ \ \ //\ Oops!\ Which\ overload\ did\ you\ want?}}
\DoxyCodeLine{02099\ \textcolor{comment}{//\ \ \ ON\_CALL(mock,\ OverloadedMethod).WillByDefault(...);}}
\DoxyCodeLine{02100\ \textcolor{comment}{//\ \ \ \ \ =>\ ERROR:\ call\ to\ member\ function\ 'gmock\_OverloadedMethod'\ is\ ambiguous}}
\DoxyCodeLine{02101\ \textcolor{comment}{//}}
\DoxyCodeLine{02102\ \textcolor{comment}{//\ How\ this\ works:\ The\ mock\ class\ uses\ two\ overloads\ of\ the\ gmock\_Method}}
\DoxyCodeLine{02103\ \textcolor{comment}{//\ expectation\ setter\ method\ plus\ an\ operator()\ overload\ on\ the\ MockSpec\ object.}}
\DoxyCodeLine{02104\ \textcolor{comment}{//\ In\ the\ matcher\ list\ form,\ the\ macro\ expands\ to:}}
\DoxyCodeLine{02105\ \textcolor{comment}{//}}
\DoxyCodeLine{02106\ \textcolor{comment}{//\ \ \ //\ This\ statement:}}
\DoxyCodeLine{02107\ \textcolor{comment}{//\ \ \ ON\_CALL(mock,\ TwoArgsMethod(\_,\ 45))...}}
\DoxyCodeLine{02108\ \textcolor{comment}{//}}
\DoxyCodeLine{02109\ \textcolor{comment}{//\ \ \ //\ ...expands\ to:}}
\DoxyCodeLine{02110\ \textcolor{comment}{//\ \ \ mock.gmock\_TwoArgsMethod(\_,\ 45)(WithoutMatchers(),\ nullptr)...}}
\DoxyCodeLine{02111\ \textcolor{comment}{//\ \ \ |-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/v-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/||-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/v-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/|}}
\DoxyCodeLine{02112\ \textcolor{comment}{//\ \ \ \ \ \ \ invokes\ first\ overload\ \ \ \ \ \ \ \ swallowed\ by\ operator()}}
\DoxyCodeLine{02113\ \textcolor{comment}{//}}
\DoxyCodeLine{02114\ \textcolor{comment}{//\ \ \ //\ ...which\ is\ essentially:}}
\DoxyCodeLine{02115\ \textcolor{comment}{//\ \ \ mock.gmock\_TwoArgsMethod(\_,\ 45)...}}
\DoxyCodeLine{02116\ \textcolor{comment}{//}}
\DoxyCodeLine{02117\ \textcolor{comment}{//\ Whereas\ the\ form\ without\ a\ matcher\ list:}}
\DoxyCodeLine{02118\ \textcolor{comment}{//}}
\DoxyCodeLine{02119\ \textcolor{comment}{//\ \ \ //\ This\ statement:}}
\DoxyCodeLine{02120\ \textcolor{comment}{//\ \ \ ON\_CALL(mock,\ TwoArgsMethod)...}}
\DoxyCodeLine{02121\ \textcolor{comment}{//}}
\DoxyCodeLine{02122\ \textcolor{comment}{//\ \ \ //\ ...expands\ to:}}
\DoxyCodeLine{02123\ \textcolor{comment}{//\ \ \ mock.gmock\_TwoArgsMethod(WithoutMatchers(),\ nullptr)...}}
\DoxyCodeLine{02124\ \textcolor{comment}{//\ \ \ |-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/v-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/|}}
\DoxyCodeLine{02125\ \textcolor{comment}{//\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ invokes\ second\ overload}}
\DoxyCodeLine{02126\ \textcolor{comment}{//}}
\DoxyCodeLine{02127\ \textcolor{comment}{//\ \ \ //\ ...which\ is\ essentially:}}
\DoxyCodeLine{02128\ \textcolor{comment}{//\ \ \ mock.gmock\_TwoArgsMethod(\_,\ \_)...}}
\DoxyCodeLine{02129\ \textcolor{comment}{//}}
\DoxyCodeLine{02130\ \textcolor{comment}{//\ The\ WithoutMatchers()\ argument\ is\ used\ to\ disambiguate\ overloads\ and\ to}}
\DoxyCodeLine{02131\ \textcolor{comment}{//\ block\ the\ caller\ from\ accidentally\ invoking\ the\ second\ overload\ directly.\ The}}
\DoxyCodeLine{02132\ \textcolor{comment}{//\ second\ argument\ is\ an\ internal\ type\ derived\ from\ the\ method\ signature.\ The}}
\DoxyCodeLine{02133\ \textcolor{comment}{//\ failure\ to\ disambiguate\ two\ overloads\ of\ this\ method\ in\ the\ ON\_CALL\ statement}}
\DoxyCodeLine{02134\ \textcolor{comment}{//\ is\ how\ we\ block\ callers\ from\ setting\ expectations\ on\ overloaded\ methods.}}
\DoxyCodeLine{02135\ \textcolor{preprocessor}{\#define\ GMOCK\_ON\_CALL\_IMPL\_(mock\_expr,\ Setter,\ call)\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \(\backslash\)}}
\DoxyCodeLine{02136\ \textcolor{preprocessor}{\ \ ((mock\_expr).gmock\_\#\#call)(::testing::internal::GetWithoutMatchers(),\ \(\backslash\)}}
\DoxyCodeLine{02137\ \textcolor{preprocessor}{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ nullptr)\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \(\backslash\)}}
\DoxyCodeLine{02138\ \textcolor{preprocessor}{\ \ \ \ \ \ .Setter(\_\_FILE\_\_,\ \_\_LINE\_\_,\ \#mock\_expr,\ \#call)}}
\DoxyCodeLine{02139\ }
\DoxyCodeLine{02140\ \textcolor{preprocessor}{\#define\ ON\_CALL(obj,\ call)\ \(\backslash\)}}
\DoxyCodeLine{02141\ \textcolor{preprocessor}{\ \ GMOCK\_ON\_CALL\_IMPL\_(obj,\ InternalDefaultActionSetAt,\ call)}}
\DoxyCodeLine{02142\ }
\DoxyCodeLine{02143\ \textcolor{preprocessor}{\#define\ EXPECT\_CALL(obj,\ call)\ \(\backslash\)}}
\DoxyCodeLine{02144\ \textcolor{preprocessor}{\ \ GMOCK\_ON\_CALL\_IMPL\_(obj,\ InternalExpectedAt,\ call)}}
\DoxyCodeLine{02145\ }
\DoxyCodeLine{02146\ \textcolor{preprocessor}{\#endif\ \ }\textcolor{comment}{//\ GOOGLEMOCK\_INCLUDE\_GMOCK\_GMOCK\_SPEC\_BUILDERS\_H\_}}
