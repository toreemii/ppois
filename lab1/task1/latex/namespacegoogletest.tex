...
-\/fail-\/if-\/no-\/test-\/selected-\/test

-\/fail-\/if-\/no-\/test-\/linked-\/test
...
\begin{DoxyVerb}Tests for Google Test's --gtest_fail_if_no_test_linked flag.\end{DoxyVerb}


\begin{DoxyVerb}Tests for Google Test's --gtest_fail_if_no_test_selected flag.\end{DoxyVerb}
