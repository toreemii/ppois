...
\label{md_googletest_2docs_2reference_2actions_autotoc_md245}%
\Hypertarget{md_googletest_2docs_2reference_2actions_autotoc_md245}%
 \href{../gmock_for_dummies.md\#actions-what-should-it-do}{\texttt{ {\bfseries{Actions}}}} specify what a mock function should do when invoked. This page lists the built-\/in actions provided by Google\+Test. All actions are defined in the {\ttfamily \+::testing} namespace.\hypertarget{md_googletest_2docs_2reference_2actions_autotoc_md246}{}\doxysection{\texorpdfstring{Returning a Value}{Returning a Value}}\label{md_googletest_2docs_2reference_2actions_autotoc_md246}
\tabulinesep=1mm
...
\end{longtabu}
\hypertarget{md_googletest_2docs_2reference_2actions_autotoc_md247}{}\doxysection{\texorpdfstring{Side Effects}{Side Effects}}\label{md_googletest_2docs_2reference_2actions_autotoc_md247}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
{\ttfamily Save\+Arg\texorpdfstring{$<$}{<}N\texorpdfstring{$>$}{>}(pointer)}   &Save the {\ttfamily N}-\/th (0-\/based) argument to {\ttfamily \texorpdfstring{$\ast$}{*}pointer} by copy-\/assignment.    \\\cline{1-2}
{\ttfamily Save\+Arg\+By\+Move\texorpdfstring{$<$}{<}N\texorpdfstring{$>$}{>}(pointer)}   &Save the {\ttfamily N}-\/th (0-\/based) argument to {\ttfamily \texorpdfstring{$\ast$}{*}pointer} by move-\/assignment.    \\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_googletest_2docs_2reference_2actions_autotoc_md248}{}\doxysection{\texorpdfstring{Using a Function, Functor, or Lambda as an Action}{Using a Function, Functor, or Lambda as an Action}}\label{md_googletest_2docs_2reference_2actions_autotoc_md248}
...
The return value of the invoked function (except {\ttfamily Invoke\+Argument}) is used as the return value of the action.
...
calls the mock function\textquotesingle{}s \#2 argument, passing to it {\ttfamily 5} and {\ttfamily string("{}\+Hi"{})} by value, and {\ttfamily foo} by reference.\hypertarget{md_googletest_2docs_2reference_2actions_autotoc_md249}{}\doxysection{\texorpdfstring{Default Action}{Default Action}}\label{md_googletest_2docs_2reference_2actions_autotoc_md249}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\{\+: .callout .note\} {\bfseries{Note\+:}} due to technical reasons, {\ttfamily Do\+Default()} cannot be used inside a composite action -\/ trying to do so will result in a run-\/time error.\hypertarget{md_googletest_2docs_2reference_2actions_autotoc_md250}{}\doxysection{\texorpdfstring{Composite Actions}{Composite Actions}}\label{md_googletest_2docs_2reference_2actions_autotoc_md250}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_googletest_2docs_2reference_2actions_autotoc_md251}{}\doxysection{\texorpdfstring{Defining Actions}{Defining Actions}}\label{md_googletest_2docs_2reference_2actions_autotoc_md251}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
