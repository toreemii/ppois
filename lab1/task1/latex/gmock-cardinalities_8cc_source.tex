...
\hypertarget{gmock-cardinalities_8cc_source}{}\label{gmock-cardinalities_8cc_source}\index{googletest/googlemock/src/gmock-\/cardinalities.cc@{googletest/googlemock/src/gmock-\/cardinalities.cc}}
...
\DoxyCodeLine{00056\ \ \ \ \ \ \ ss\ <<\ \textcolor{stringliteral}{"{}The\ invocation\ lower\ bound\ must\ be\ >=\ 0,\ "{}}\ <<\ \textcolor{stringliteral}{"{}but\ is\ actually\ "{}}}
\DoxyCodeLine{00057\ \ \ \ \ \ \ \ \ \ <<\ min\ <<\ \textcolor{stringliteral}{"{}."{}};}
...
\DoxyCodeLine{00060\ \ \ \ \ \ \ ss\ <<\ \textcolor{stringliteral}{"{}The\ invocation\ upper\ bound\ must\ be\ >=\ 0,\ "{}}\ <<\ \textcolor{stringliteral}{"{}but\ is\ actually\ "{}}}
\DoxyCodeLine{00061\ \ \ \ \ \ \ \ \ \ <<\ max\ <<\ \textcolor{stringliteral}{"{}."{}};}
