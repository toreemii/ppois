...
\label{md_googletest_2docs_2reference_2mocking_autotoc_md265}%
\Hypertarget{md_googletest_2docs_2reference_2mocking_autotoc_md265}%
...
Google\+Test defines the following macros for working with mocks.\hypertarget{md_googletest_2docs_2reference_2mocking_MOCK_METHOD}{}\doxysubsection{\texorpdfstring{MOCK\+\_\+\+METHOD}{MOCK\_METHOD}}\label{md_googletest_2docs_2reference_2mocking_MOCK_METHOD}
...
See details for each modifier clause below.\hypertarget{md_googletest_2docs_2reference_2mocking_autotoc_md266}{}\doxysubsubsection{\texorpdfstring{With \{\#\+EXPECT\+\_\+\+CALL.\+With\}}{With \{\#EXPECT\_CALL.With\}}}\label{md_googletest_2docs_2reference_2mocking_autotoc_md266}
...
The {\ttfamily With} clause can be used at most once on an expectation and must be the first clause.\hypertarget{md_googletest_2docs_2reference_2mocking_autotoc_md267}{}\doxysubsubsection{\texorpdfstring{Times \{\#\+EXPECT\+\_\+\+CALL.\+Times\}}{Times \{\#EXPECT\_CALL.Times\}}}\label{md_googletest_2docs_2reference_2mocking_autotoc_md267}
...
The {\ttfamily Times} clause can be used at most once on an expectation.\hypertarget{md_googletest_2docs_2reference_2mocking_autotoc_md268}{}\doxysubsubsection{\texorpdfstring{In\+Sequence \{\#\+EXPECT\+\_\+\+CALL.\+In\+Sequence\}}{InSequence \{\#EXPECT\_CALL.InSequence\}}}\label{md_googletest_2docs_2reference_2mocking_autotoc_md268}
{\ttfamily .In\+Sequence(}\texorpdfstring{$\ast$}{*}{\ttfamily sequences...}\texorpdfstring{$\ast$}{*}{\ttfamily )}

Specifies that the mock function call is expected in a certain sequence.

The parameter \texorpdfstring{$\ast$}{*}{\ttfamily sequences...}\texorpdfstring{$\ast$}{*} is any number of \doxysectlink{md_googletest_2docs_2reference_2mocking_Sequence}{\`{}\+Sequence\`{}}{2} objects. Expected calls assigned to the same sequence are expected to occur in the order the expectations are declared.
...
See also the \doxysectlink{md_googletest_2docs_2reference_2mocking_InSequence}{\`{}\+In\+Sequence\`{} class}{2}.\hypertarget{md_googletest_2docs_2reference_2mocking_autotoc_md269}{}\doxysubsubsection{\texorpdfstring{After \{\#\+EXPECT\+\_\+\+CALL.\+After\}}{After \{\#EXPECT\_CALL.After\}}}\label{md_googletest_2docs_2reference_2mocking_autotoc_md269}
...
The {\ttfamily After} clause can be used any number of times on an expectation.\hypertarget{md_googletest_2docs_2reference_2mocking_autotoc_md270}{}\doxysubsubsection{\texorpdfstring{Will\+Once \{\#\+EXPECT\+\_\+\+CALL.\+Will\+Once\}}{WillOnce \{\#EXPECT\_CALL.WillOnce\}}}\label{md_googletest_2docs_2reference_2mocking_autotoc_md270}
...
The parameter \texorpdfstring{$\ast$}{*}{\ttfamily action}\texorpdfstring{$\ast$}{*} represents the \href{../gmock_for_dummies.md\#actions-what-should-it-do}{\texttt{ action}} that the function call will perform. See the \doxysectlink{md_googletest_2docs_2reference_2actions}{Actions Reference}{0} for a list of built-\/in actions.
...
The {\ttfamily Will\+Once} clause can be used any number of times on an expectation. Unlike {\ttfamily Will\+Repeatedly}, the action fed to each {\ttfamily Will\+Once} call will be called at most once, so may be a move-\/only type and/or have an {\ttfamily \&\&}-\/qualified call operator.\hypertarget{md_googletest_2docs_2reference_2mocking_autotoc_md271}{}\doxysubsubsection{\texorpdfstring{Will\+Repeatedly \{\#\+EXPECT\+\_\+\+CALL.\+Will\+Repeatedly\}}{WillRepeatedly \{\#EXPECT\_CALL.WillRepeatedly\}}}\label{md_googletest_2docs_2reference_2mocking_autotoc_md271}
...
The {\ttfamily Will\+Repeatedly} clause can be used at most once on an expectation.\hypertarget{md_googletest_2docs_2reference_2mocking_autotoc_md272}{}\doxysubsubsection{\texorpdfstring{Retires\+On\+Saturation \{\#\+EXPECT\+\_\+\+CALL.\+Retires\+On\+Saturation\}}{RetiresOnSaturation \{\#EXPECT\_CALL.RetiresOnSaturation\}}}\label{md_googletest_2docs_2reference_2mocking_autotoc_md272}
...
The {\ttfamily Retires\+On\+Saturation} clause can be used at most once on an expectation and must be the last clause.\hypertarget{md_googletest_2docs_2reference_2mocking_ON_CALL}{}\doxysubsection{\texorpdfstring{ON\+\_\+\+CALL}{ON\_CALL}}\label{md_googletest_2docs_2reference_2mocking_ON_CALL}
...
See details for each modifier clause below.\hypertarget{md_googletest_2docs_2reference_2mocking_autotoc_md273}{}\doxysubsubsection{\texorpdfstring{With \{\#\+ON\+\_\+\+CALL.\+With\}}{With \{\#ON\_CALL.With\}}}\label{md_googletest_2docs_2reference_2mocking_autotoc_md273}
{\ttfamily .With(}\texorpdfstring{$\ast$}{*}{\ttfamily multi\+\_\+argument\+\_\+matcher}\texorpdfstring{$\ast$}{*}{\ttfamily )}
...
The {\ttfamily With} clause can be used at most once with each {\ttfamily ON\+\_\+\+CALL} statement.\hypertarget{md_googletest_2docs_2reference_2mocking_autotoc_md274}{}\doxysubsubsection{\texorpdfstring{Will\+By\+Default \{\#\+ON\+\_\+\+CALL.\+Will\+By\+Default\}}{WillByDefault \{\#ON\_CALL.WillByDefault\}}}\label{md_googletest_2docs_2reference_2mocking_autotoc_md274}
...
{\ttfamily \doxylink{classtesting_1_1DefaultValue}{testing\+::\+Default\+Value}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}
...
\end{DoxyCode}
\hypertarget{md_googletest_2docs_2reference_2mocking_NiceMock}{}\doxysubsection{\texorpdfstring{Nice\+Mock}{NiceMock}}\label{md_googletest_2docs_2reference_2mocking_NiceMock}
{\ttfamily \doxylink{classtesting_1_1NiceMock}{testing\+::\+Nice\+Mock}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}
...
{\ttfamily Nice\+Mock\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} might not work correctly if the destructor of {\ttfamily T} is not virtual.\hypertarget{md_googletest_2docs_2reference_2mocking_NaggyMock}{}\doxysubsection{\texorpdfstring{Naggy\+Mock}{NaggyMock}}\label{md_googletest_2docs_2reference_2mocking_NaggyMock}
{\ttfamily \doxylink{classtesting_1_1NaggyMock}{testing\+::\+Naggy\+Mock}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}
...
\doxylink{classMock}{Mock} objects of type {\ttfamily T} by default behave the same way as {\ttfamily Naggy\+Mock\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}.\hypertarget{md_googletest_2docs_2reference_2mocking_StrictMock}{}\doxysubsection{\texorpdfstring{Strict\+Mock}{StrictMock}}\label{md_googletest_2docs_2reference_2mocking_StrictMock}
{\ttfamily \doxylink{classtesting_1_1StrictMock}{testing\+::\+Strict\+Mock}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}
...
Represents a chronological sequence of expectations. See the \`{}\+In\+Sequence\`{} clause of {\ttfamily EXPECT\+\_\+\+CALL} for usage.\hypertarget{md_googletest_2docs_2reference_2mocking_InSequence}{}\doxysubsection{\texorpdfstring{In\+Sequence}{InSequence}}\label{md_googletest_2docs_2reference_2mocking_InSequence}
...
Useful for specifying sequences of expectations; see the \`{}\+After\`{} clause of {\ttfamily EXPECT\+\_\+\+CALL}.\hypertarget{md_googletest_2docs_2reference_2mocking_ExpectationSet}{}\doxysubsection{\texorpdfstring{Expectation\+Set}{ExpectationSet}}\label{md_googletest_2docs_2reference_2mocking_ExpectationSet}
