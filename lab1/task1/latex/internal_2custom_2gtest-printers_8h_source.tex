...
\hypertarget{internal_2custom_2gtest-printers_8h_source}{}\label{internal_2custom_2gtest-printers_8h_source}\index{googletest/googletest/include/gtest/internal/custom/gtest-\/printers.h@{googletest/googletest/include/gtest/internal/custom/gtest-\/printers.h}}
...
\DoxyCodeLine{00030\ \textcolor{comment}{//\ This\ file\ provides\ an\ injection\ point\ for\ custom\ printers\ in\ a\ local}}
\DoxyCodeLine{00031\ \textcolor{comment}{//\ installation\ of\ gTest.}}
\DoxyCodeLine{00032\ \textcolor{comment}{//\ It\ will\ be\ included\ from\ gtest-\/printers.h\ and\ the\ overrides\ in\ this\ file}}
\DoxyCodeLine{00033\ \textcolor{comment}{//\ will\ be\ visible\ to\ everyone.}}
\DoxyCodeLine{00034\ \textcolor{comment}{//}}
\DoxyCodeLine{00035\ \textcolor{comment}{//\ Injection\ point\ for\ custom\ user\ configurations.\ See\ README\ for\ details}}
\DoxyCodeLine{00036\ \textcolor{comment}{//}}
\DoxyCodeLine{00037\ \textcolor{comment}{//\ **\ Custom\ implementation\ starts\ here\ **}}
\DoxyCodeLine{00038\ }
\DoxyCodeLine{00039\ \textcolor{preprocessor}{\#ifndef\ GOOGLETEST\_INCLUDE\_GTEST\_INTERNAL\_CUSTOM\_GTEST\_PRINTERS\_H\_}}
\DoxyCodeLine{00040\ \textcolor{preprocessor}{\#define\ GOOGLETEST\_INCLUDE\_GTEST\_INTERNAL\_CUSTOM\_GTEST\_PRINTERS\_H\_}}
\DoxyCodeLine{00041\ }
\DoxyCodeLine{00042\ \textcolor{preprocessor}{\#endif\ \ }\textcolor{comment}{//\ GOOGLETEST\_INCLUDE\_GTEST\_INTERNAL\_CUSTOM\_GTEST\_PRINTERS\_H\_}}
