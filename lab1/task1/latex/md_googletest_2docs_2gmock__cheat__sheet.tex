...
\label{md_googletest_2docs_2gmock__cheat__sheet_autotoc_md111}%
\Hypertarget{md_googletest_2docs_2gmock__cheat__sheet_autotoc_md111}%
 \hypertarget{md_googletest_2docs_2gmock__cheat__sheet_autotoc_md112}{}\doxysection{\texorpdfstring{Defining a Mock Class}{Defining a Mock Class}}\label{md_googletest_2docs_2gmock__cheat__sheet_autotoc_md112}
...
\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cheat__sheet_autotoc_md113}{}\doxysubsection{\texorpdfstring{Specifying Calling Conventions for Mock Functions}{Specifying Calling Conventions for Mock Functions}}\label{md_googletest_2docs_2gmock__cheat__sheet_autotoc_md113}
...
See the \href{reference/mocking.md\#EXPECT_CALL.Times}{\texttt{ {\ttfamily Times} clause}} of {\ttfamily EXPECT\+\_\+\+CALL} in the Mocking Reference.\hypertarget{md_googletest_2docs_2gmock__cheat__sheet_autotoc_md114}{}\doxysection{\texorpdfstring{Expectation Order}{Expectation Order}}\label{md_googletest_2docs_2gmock__cheat__sheet_autotoc_md114}
By default, expectations can be matched in {\itshape any} order. If some or all expectations must be matched in a given order, you can use the \href{reference/mocking.md\#EXPECT_CALL.After}{\texttt{ {\ttfamily After} clause}} or \href{reference/mocking.md\#EXPECT_CALL.InSequence}{\texttt{ {\ttfamily In\+Sequence} clause}} of {\ttfamily EXPECT\+\_\+\+CALL}, or use an \href{reference/mocking.md\#InSequence}{\texttt{ {\ttfamily In\+Sequence} object}}.\hypertarget{md_googletest_2docs_2gmock__cheat__sheet_autotoc_md115}{}\doxysection{\texorpdfstring{Verifying and Resetting a Mock}{Verifying and Resetting a Mock}}\label{md_googletest_2docs_2gmock__cheat__sheet_autotoc_md115}
...
\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cheat__sheet_autotoc_md116}{}\doxysection{\texorpdfstring{Mock Classes}{Mock Classes}}\label{md_googletest_2docs_2gmock__cheat__sheet_autotoc_md116}
...
See this \href{gmock_cook_book.md\#UsingCheckPoints}{\texttt{ recipe}} for one application of it.\hypertarget{md_googletest_2docs_2gmock__cheat__sheet_autotoc_md117}{}\doxysection{\texorpdfstring{Flags}{Flags}}\label{md_googletest_2docs_2gmock__cheat__sheet_autotoc_md117}
\tabulinesep=1mm
...
{\ttfamily -\/-\/gmock\+\_\+verbose=LEVEL}   &Sets the default verbosity level ({\ttfamily info}, {\ttfamily warning}, or {\ttfamily error}) of Google \doxylink{classMock}{Mock} messages.   \\\cline{1-2}
\end{longtabu}
