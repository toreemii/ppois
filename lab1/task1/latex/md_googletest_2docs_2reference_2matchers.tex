...
\hypertarget{md_googletest_2docs_2reference_2matchers}{}\label{md_googletest_2docs_2reference_2matchers}\index{Matchers Reference@{Matchers Reference}}
\label{md_googletest_2docs_2reference_2matchers_autotoc_md253}%
\Hypertarget{md_googletest_2docs_2reference_2matchers_autotoc_md253}%
...
Built-\/in matchers (where {\ttfamily argument} is the function argument, e.\+g. {\ttfamily actual\+\_\+value} in the example above, or when used in the context of {\ttfamily EXPECT\+\_\+\+CALL(mock\+\_\+object, method(matchers))}, the arguments of {\ttfamily method}) are divided into several categories. All matchers are defined in the {\ttfamily \+::testing} namespace unless otherwise noted.\hypertarget{md_googletest_2docs_2reference_2matchers_autotoc_md254}{}\doxysection{\texorpdfstring{Wildcard}{Wildcard}}\label{md_googletest_2docs_2reference_2matchers_autotoc_md254}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_googletest_2docs_2reference_2matchers_autotoc_md255}{}\doxysection{\texorpdfstring{Generic Comparison}{Generic Comparison}}\label{md_googletest_2docs_2reference_2matchers_autotoc_md255}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
{\ttfamily Distance\+From(target, m)}   &The distance between {\ttfamily argument} and {\ttfamily target} (computed by {\ttfamily abs(argument -\/ target)}) matches {\ttfamily m}.    \\\cline{1-2}
{\ttfamily Distance\+From(target, get\+\_\+distance, m)}   &The distance between {\ttfamily argument} and {\ttfamily target} (computed by {\ttfamily get\+\_\+distance(argument, target)}) matches {\ttfamily m}.    \\\cline{1-2}
...
{\ttfamily Is\+True} and {\ttfamily Is\+False} are useful when you need to use a matcher, or for types that can be explicitly converted to Boolean, but are not implicitly converted to Boolean. In other cases, you can use the basic \href{assertions.md\#boolean}{\texttt{ {\ttfamily EXPECT\+\_\+\+TRUE} and {\ttfamily EXPECT\+\_\+\+FALSE}}} assertions.\hypertarget{md_googletest_2docs_2reference_2matchers_FpMatchers}{}\doxysection{\texorpdfstring{Floating-\/\+Point Matchers}{Floating-Point Matchers}}\label{md_googletest_2docs_2reference_2matchers_FpMatchers}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_googletest_2docs_2reference_2matchers_autotoc_md256}{}\doxysection{\texorpdfstring{String Matchers}{String Matchers}}\label{md_googletest_2docs_2reference_2matchers_autotoc_md256}
...
{\ttfamily When\+Base64\+Unescaped(m)}   &{\ttfamily argument} is a base-\/64 escaped string whose unescaped string matches {\ttfamily m}. The web-\/safe format from \href{https://www.rfc-editor.org/rfc/rfc4648\#section-5}{\texttt{ RFC 4648}} is supported.   \\\cline{1-2}
\end{longtabu}


{\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} take ownership of the {\ttfamily RE} object. They use the regular expression syntax defined \href{../advanced.md\#regular-expression-syntax}{\texttt{ here}}. All of these matchers, except {\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} work for wide strings as well.\hypertarget{md_googletest_2docs_2reference_2matchers_autotoc_md257}{}\doxysection{\texorpdfstring{Exception Matchers}{Exception Matchers}}\label{md_googletest_2docs_2reference_2matchers_autotoc_md257}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
\endhead
{\ttfamily Throws\texorpdfstring{$<$}{<}E\texorpdfstring{$>$}{>}()}   &The {\ttfamily argument} is a callable object that, when called, throws an exception of the expected type {\ttfamily E}.    \\\cline{1-2}
{\ttfamily Throws\texorpdfstring{$<$}{<}E\texorpdfstring{$>$}{>}(m)}   &The {\ttfamily argument} is a callable object that, when called, throws an exception of type {\ttfamily E} that satisfies the matcher {\ttfamily m}.    \\\cline{1-2}
{\ttfamily Throws\+Message\texorpdfstring{$<$}{<}E\texorpdfstring{$>$}{>}(m)}   &The {\ttfamily argument} is a callable object that, when called, throws an exception of type {\ttfamily E} with a message that satisfies the matcher {\ttfamily m}.   \\\cline{1-2}
\end{longtabu}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{auto}\ argument\ =\ []\ \{\ \textcolor{keywordflow}{throw}\ std::runtime\_error(\textcolor{stringliteral}{"{}error\ msg"{}});\ \};}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{//\ Checks\ if\ the\ lambda\ throws\ a\ \`{}std::runtime\_error`.}}
\DoxyCodeLine{EXPECT\_THAT(argument,\ Throws<std::runtime\_error>());}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{//\ Checks\ if\ the\ lambda\ throws\ a\ \`{}std::runtime\_error`\ with\ a\ specific\ message}}
\DoxyCodeLine{\textcolor{comment}{//\ that\ matches\ "{}error\ msg"{}.}}
\DoxyCodeLine{EXPECT\_THAT(argument,}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ Throws<std::runtime\_error>(Property(\&std::runtime\_error::what,}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ Eq(\textcolor{stringliteral}{"{}error\ msg"{}}))));}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{//\ Checks\ if\ the\ lambda\ throws\ a\ \`{}std::runtime\_error`\ with\ a\ message\ that}}
\DoxyCodeLine{\textcolor{comment}{//\ contains\ "{}msg"{}.}}
\DoxyCodeLine{EXPECT\_THAT(argument,\ ThrowsMessage<std::runtime\_error>(HasSubstr(\textcolor{stringliteral}{"{}msg"{}})));}

\end{DoxyCode}
\hypertarget{md_googletest_2docs_2reference_2matchers_autotoc_md258}{}\doxysection{\texorpdfstring{Container Matchers}{Container Matchers}}\label{md_googletest_2docs_2reference_2matchers_autotoc_md258}
...
\item an array passed as a pointer and a count (e.\+g. in {\ttfamily Bar(const T\texorpdfstring{$\ast$}{*} buffer,         int len)} -- see \doxysectlink{md_googletest_2docs_2reference_2matchers_MultiArgMatchers}{Multi-\/argument Matchers}{1}).
\end{DoxyEnumerate}
...
\end{DoxyItemize}\hypertarget{md_googletest_2docs_2reference_2matchers_autotoc_md259}{}\doxysection{\texorpdfstring{Member Matchers}{Member Matchers}}\label{md_googletest_2docs_2reference_2matchers_autotoc_md259}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\{\+: .callout .warning\} Warning\+: Don\textquotesingle{}t use {\ttfamily Property()} against member functions that you do not own, because taking addresses of functions is fragile and generally not part of the contract of the function.
...
\end{DoxyItemize}\hypertarget{md_googletest_2docs_2reference_2matchers_autotoc_md260}{}\doxysection{\texorpdfstring{Matching the Result of a Function, Functor, or Callback}{Matching the Result of a Function, Functor, or Callback}}\label{md_googletest_2docs_2reference_2matchers_autotoc_md260}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_googletest_2docs_2reference_2matchers_autotoc_md261}{}\doxysection{\texorpdfstring{Pointer Matchers}{Pointer Matchers}}\label{md_googletest_2docs_2reference_2matchers_autotoc_md261}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_googletest_2docs_2reference_2matchers_MultiArgMatchers}{}\doxysection{\texorpdfstring{Multi-\/argument Matchers}{Multi-argument Matchers}}\label{md_googletest_2docs_2reference_2matchers_MultiArgMatchers}
...
\end{longtabu}
\hypertarget{md_googletest_2docs_2reference_2matchers_autotoc_md262}{}\doxysection{\texorpdfstring{Composite Matchers}{Composite Matchers}}\label{md_googletest_2docs_2reference_2matchers_autotoc_md262}
...
\end{longtabu}
\hypertarget{md_googletest_2docs_2reference_2matchers_autotoc_md263}{}\doxysection{\texorpdfstring{Adapters for Matchers}{Adapters for Matchers}}\label{md_googletest_2docs_2reference_2matchers_autotoc_md263}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
{\ttfamily Address\+Satisfies(callback)} and {\ttfamily Truly(callback)} take ownership of {\ttfamily callback}, which must be a permanent callback.\hypertarget{md_googletest_2docs_2reference_2matchers_MatchersAsPredicatesCheat}{}\doxysection{\texorpdfstring{Using Matchers as Predicates}{Using Matchers as Predicates}}\label{md_googletest_2docs_2reference_2matchers_MatchersAsPredicatesCheat}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_googletest_2docs_2reference_2matchers_autotoc_md264}{}\doxysection{\texorpdfstring{Defining Matchers}{Defining Matchers}}\label{md_googletest_2docs_2reference_2matchers_autotoc_md264}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Macro   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\item You can use {\ttfamily Describe\+Matcher\texorpdfstring{$<$}{<}\texorpdfstring{$>$}{>}} to describe another matcher. For example\+:

{\ttfamily cpp MATCHER\+\_\+P(XAnd\+YThat, matcher, "{}\+X that "{} + Describe\+Matcher\texorpdfstring{$<$}{<}int\texorpdfstring{$>$}{>}(matcher, negation) + (negation ? "{} or"{} \+: "{} and"{}) + "{} Y that "{} + Describe\+Matcher\texorpdfstring{$<$}{<}double\texorpdfstring{$>$}{>}(matcher, negation)) \{ return Explain\+Match\+Result(matcher, arg.\+x(), result\+\_\+listener) \&\& Explain\+Match\+Result(matcher, arg.\+y(), result\+\_\+listener); \} } 
\end{DoxyEnumerate}