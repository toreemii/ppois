\doxysection{gtest-\/typed-\/test2\+\_\+test.cc}
\hypertarget{gtest-typed-test2__test_8cc_source}{}\label{gtest-typed-test2__test_8cc_source}\index{googletest/googletest/test/gtest-\/typed-\/test2\_test.cc@{googletest/googletest/test/gtest-\/typed-\/test2\_test.cc}}
...
\DoxyCodeLine{00033\ \textcolor{preprocessor}{\#include\ "{}test/gtest-\/typed-\/test\_test.h"{}}}
\DoxyCodeLine{00034\ }
\DoxyCodeLine{00035\ \textcolor{comment}{//\ Tests\ that\ the\ same\ type-\/parameterized\ test\ case\ can\ be}}
\DoxyCodeLine{00036\ \textcolor{comment}{//\ instantiated\ in\ different\ translation\ units\ linked\ together.}}
\DoxyCodeLine{00037\ \textcolor{comment}{//\ (ContainerTest\ is\ also\ instantiated\ in\ gtest-\/typed-\/test\_test.cc.)}}
\DoxyCodeLine{00038\ INSTANTIATE\_TYPED\_TEST\_SUITE\_P(Vector,\ \mbox{\hyperlink{classContainerTest}{ContainerTest}},}
\DoxyCodeLine{00039\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{structtesting_1_1internal_1_1ProxyTypeList}{testing::Types}}<std::vector<int>\ >);}
