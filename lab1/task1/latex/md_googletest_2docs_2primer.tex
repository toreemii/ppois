...
\hypertarget{md_googletest_2docs_2primer}{}\label{md_googletest_2docs_2primer}\index{GoogleTest Primer@{GoogleTest Primer}}
\label{md_googletest_2docs_2primer_autotoc_md226}%
\Hypertarget{md_googletest_2docs_2primer_autotoc_md226}%
 \hypertarget{md_googletest_2docs_2primer_autotoc_md227}{}\doxysection{\texorpdfstring{Introduction\+: Why Google\+Test?}{Introduction: Why GoogleTest?}}\label{md_googletest_2docs_2primer_autotoc_md227}
...
Historically, Google\+Test started to use the term {\itshape Test Case} for grouping related tests, whereas current publications, including International Software Testing Qualifications Board (\href{https://www.istqb.org/}{\texttt{ ISTQB}}) materials and various textbooks on software quality, use the term {\itshape \href{https://glossary.istqb.org/en_US/term/test-suite}{\texttt{ Test Suite}}} for this.

The related term {\itshape Test}, as it is used in Google\+Test, corresponds to the term {\itshape \href{https://glossary.istqb.org/en_US/term/test-case}{\texttt{ Test Case}}} of ISTQB and others.
...
\cellcolor{\tableheadbgcolor}\textbf{ Meaning   }&\cellcolor{\tableheadbgcolor}\textbf{ Google\+Test Term   }&\cellcolor{\tableheadbgcolor}\textbf{ \href{https://www.istqb.org/}{\texttt{ ISTQB}} Term    }\\\cline{1-3}
\endhead
Exercise a particular program path with specific input values and verify the results   &TEST()   &\href{https://glossary.istqb.org/en_US/term/test-case}{\texttt{ Test Case}}   \\\cline{1-3}
\end{longtabu}
\hypertarget{md_googletest_2docs_2primer_autotoc_md229}{}\doxysection{\texorpdfstring{Basic Concepts}{Basic Concepts}}\label{md_googletest_2docs_2primer_autotoc_md229}
...
We\textquotesingle{}ll now explain how to write a test program, starting at the individual assertion level and building up to tests and test suites.\hypertarget{md_googletest_2docs_2primer_autotoc_md230}{}\doxysection{\texorpdfstring{Assertions}{Assertions}}\label{md_googletest_2docs_2primer_autotoc_md230}
...
Google\+Test provides a collection of assertions for verifying the behavior of your code in various ways. You can check Boolean conditions, compare values based on relational operators, verify string values, floating-\/point values, and much more. There are even assertions that enable you to verify more complex states by providing custom predicates. For the complete list of assertions provided by Google\+Test, see the \doxysectlink{md_googletest_2docs_2reference_2assertions}{Assertions Reference}{0}.\hypertarget{md_googletest_2docs_2primer_autotoc_md231}{}\doxysection{\texorpdfstring{Simple Tests}{Simple Tests}}\label{md_googletest_2docs_2primer_autotoc_md231}
To create a test\+:
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_googletest_2docs_2primer_same-data-multiple-tests}{}\doxysection{\texorpdfstring{Test Fixtures\+: Using the Same Data Configuration for Multiple Tests}{Test Fixtures: Using the Same Data Configuration for Multiple Tests}}\label{md_googletest_2docs_2primer_same-data-multiple-tests}
...
\begin{DoxyEnumerate}
\item Derive a class from {\ttfamily \doxylink{classtesting_1_1Test}{testing\+::\+Test}} . Start its body with {\ttfamily protected\+:}, as we\textquotesingle{}ll want to access fixture members from sub-\/classes.
...
As an example, let\textquotesingle{}s write tests for a FIFO queue class named {\ttfamily \doxylink{classQueue}{Queue}}, which has the following interface\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{\ ++}
\DoxyCodeLine{\textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ E>\ \ \textcolor{comment}{//\ E\ is\ the\ element\ type.}}
\DoxyCodeLine{\textcolor{keyword}{class\ }\mbox{\hyperlink{classQueue}{Queue}}\ \{}
\DoxyCodeLine{\ \textcolor{keyword}{public}:}
\DoxyCodeLine{\ \ \mbox{\hyperlink{classQueue}{Queue}}();}
...
First, define a fixture class. By convention, you should give it the name {\ttfamily \doxylink{classFooTest}{Foo\+Test}} where {\ttfamily Foo} is the class being tested.


\begin{DoxyCode}{0}
\DoxyCodeLine{\ ++}
\DoxyCodeLine{\textcolor{keyword}{class\ }QueueTest\ :\ \textcolor{keyword}{public}\ \mbox{\hyperlink{classtesting_1_1Test}{testing::Test}}\ \{}
\DoxyCodeLine{\ \textcolor{keyword}{protected}:}
\DoxyCodeLine{\ \ QueueTest()\ \{}
...
\DoxyCodeLine{\ \ \}}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \textcolor{comment}{//\ \string~QueueTest()\ override\ =\ default;}}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \mbox{\hyperlink{classQueue}{Queue<int>}}\ q0\_;}
\DoxyCodeLine{\ \ \mbox{\hyperlink{classQueue}{Queue<int>}}\ q1\_;}
\DoxyCodeLine{\ \ \mbox{\hyperlink{classQueue}{Queue<int>}}\ q2\_;}
\DoxyCodeLine{\};}

\end{DoxyCode}


In this case, we don\textquotesingle{}t need to define a destructor or a {\ttfamily Tear\+Down()} method, because the implicit destructor generated by the compiler will perform all of the necessary cleanup.
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_googletest_2docs_2primer_autotoc_md232}{}\doxysection{\texorpdfstring{Invoking the Tests}{Invoking the Tests}}\label{md_googletest_2docs_2primer_autotoc_md232}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_googletest_2docs_2primer_autotoc_md233}{}\doxysection{\texorpdfstring{Writing the main() Function}{Writing the main() Function}}\label{md_googletest_2docs_2primer_autotoc_md233}
...
\{\+: .callout .note\} NOTE\+: {\ttfamily Parse\+GUnit\+Flags()} is deprecated in favor of {\ttfamily Init\+Google\+Test()}.\hypertarget{md_googletest_2docs_2primer_autotoc_md234}{}\doxysection{\texorpdfstring{Known Limitations}{Known Limitations}}\label{md_googletest_2docs_2primer_autotoc_md234}
