...
\hypertarget{sample1_8h_source}{}\label{sample1_8h_source}\index{googletest/googletest/samples/sample1.h@{googletest/googletest/samples/sample1.h}}
...
\DoxyCodeLine{00031\ }
\DoxyCodeLine{00032\ \textcolor{preprocessor}{\#ifndef\ GOOGLETEST\_SAMPLES\_SAMPLE1\_H\_}}
\DoxyCodeLine{00033\ \textcolor{preprocessor}{\#define\ GOOGLETEST\_SAMPLES\_SAMPLE1\_H\_}}
\DoxyCodeLine{00034\ }
\DoxyCodeLine{00035\ \textcolor{comment}{//\ Returns\ n!\ (the\ factorial\ of\ n).\ \ For\ negative\ n,\ n!\ is\ defined\ to\ be\ 1.}}
\DoxyCodeLine{00036\ \textcolor{keywordtype}{int}\ Factorial(\textcolor{keywordtype}{int}\ n);}
\DoxyCodeLine{00037\ }
\DoxyCodeLine{00038\ \textcolor{comment}{//\ Returns\ true\ if\ and\ only\ if\ n\ is\ a\ prime\ number.}}
\DoxyCodeLine{00039\ \textcolor{keywordtype}{bool}\ IsPrime(\textcolor{keywordtype}{int}\ n);}
\DoxyCodeLine{00040\ }
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#endif\ \ }\textcolor{comment}{//\ GOOGLETEST\_SAMPLES\_SAMPLE1\_H\_}}
