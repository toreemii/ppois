...
\hypertarget{md_googletest_2docs_2pkgconfig}{}\label{md_googletest_2docs_2pkgconfig}\index{Using GoogleTest from various build systems@{Using GoogleTest from various build systems}}
\label{md_googletest_2docs_2pkgconfig_autotoc_md221}%
\Hypertarget{md_googletest_2docs_2pkgconfig_autotoc_md221}%
...
All current build systems support pkg-\/config in one way or another. For all examples here we assume you want to compile the sample {\ttfamily samples/sample3\+\_\+unittest.\+cc}.\hypertarget{md_googletest_2docs_2pkgconfig_autotoc_md222}{}\doxysubsection{\texorpdfstring{CMake}{CMake}}\label{md_googletest_2docs_2pkgconfig_autotoc_md222}
...
pkg-\/config will also try to look in {\ttfamily PKG\+\_\+\+CONFIG\+\_\+\+PATH} to find {\ttfamily gtest\+\_\+main.\+pc}.\hypertarget{md_googletest_2docs_2pkgconfig_autotoc_md224}{}\doxysubsection{\texorpdfstring{Using pkg-\/config in a cross-\/compilation setting}{Using pkg-config in a cross-compilation setting}}\label{md_googletest_2docs_2pkgconfig_autotoc_md224}
