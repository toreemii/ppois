...
\hypertarget{production_8h_source}{}\label{production_8h_source}\index{googletest/googletest/test/production.h@{googletest/googletest/test/production.h}}
...
\DoxyCodeLine{00031\ \textcolor{comment}{//\ This\ is\ part\ of\ the\ unit\ test\ for\ gtest\_prod.h.}}
\DoxyCodeLine{00032\ }
\DoxyCodeLine{00033\ \textcolor{preprocessor}{\#ifndef\ GOOGLETEST\_TEST\_PRODUCTION\_H\_}}
\DoxyCodeLine{00034\ \textcolor{preprocessor}{\#define\ GOOGLETEST\_TEST\_PRODUCTION\_H\_}}
\DoxyCodeLine{00035\ }
\DoxyCodeLine{00036\ \textcolor{preprocessor}{\#include\ "{}gtest/gtest\_prod.h"{}}}
\DoxyCodeLine{00037\ }
\DoxyCodeLine{00038\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classPrivateCode}{PrivateCode}}\ \{}
\DoxyCodeLine{00039\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{00040\ \ \ \textcolor{comment}{//\ Declares\ a\ friend\ test\ that\ does\ not\ use\ a\ fixture.}}
\DoxyCodeLine{00041\ \ \ FRIEND\_TEST(PrivateCodeTest,\ CanAccessPrivateMembers);}
\DoxyCodeLine{00042\ }
\DoxyCodeLine{00043\ \ \ \textcolor{comment}{//\ Declares\ a\ friend\ test\ that\ uses\ a\ fixture.}}
\DoxyCodeLine{00044\ \ \ FRIEND\_TEST(\mbox{\hyperlink{classtesting_1_1Test}{PrivateCodeFixtureTest}},\ CanAccessPrivateMembers);}
\DoxyCodeLine{00045\ }
\DoxyCodeLine{00046\ \ \ \mbox{\hyperlink{classPrivateCode}{PrivateCode}}();}
\DoxyCodeLine{00047\ }
\DoxyCodeLine{00048\ \ \ \textcolor{keywordtype}{int}\ x()\textcolor{keyword}{\ const\ }\{\ \textcolor{keywordflow}{return}\ x\_;\ \}}
\DoxyCodeLine{00049\ }
\DoxyCodeLine{00050\ \ \textcolor{keyword}{private}:}
\DoxyCodeLine{00051\ \ \ \textcolor{keywordtype}{void}\ set\_x(\textcolor{keywordtype}{int}\ an\_x)\ \{\ x\_\ =\ an\_x;\ \}}
\DoxyCodeLine{00052\ \ \ \textcolor{keywordtype}{int}\ x\_;}
\DoxyCodeLine{00053\ \};}
\DoxyCodeLine{00054\ }
\DoxyCodeLine{00055\ \textcolor{preprocessor}{\#endif\ \ }\textcolor{comment}{//\ GOOGLETEST\_TEST\_PRODUCTION\_H\_}}
