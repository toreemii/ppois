...
\DoxyCodeLine{00125\ }
\DoxyCodeLine{00126\ \ \ \textcolor{keywordflow}{if}\ (!success)\ FAIL()\ <<\ \textcolor{stringliteral}{"{}GetCurrentExecutableName()\ returns\ "{}}\ <<\ exe\_str;}
\DoxyCodeLine{00127\ \}}
\DoxyCodeLine{00128\ }
...
\DoxyCodeLine{00134\ \ \ \ \ original\_working\_dir\_\ =\ FilePath::GetCurrentDir();}
...
\DoxyCodeLine{00137\ \ \ \ \ EXPECT\_NE(original\_working\_dir\_.string(),}
...
\DoxyCodeLine{00142\ \ \ \ \ posix::ChDir(original\_working\_dir\_.string().c\_str());}
\DoxyCodeLine{00143\ \ \ \}}
\DoxyCodeLine{00144\ }
\DoxyCodeLine{00145\ \ \ FilePath\ original\_working\_dir\_;}
\DoxyCodeLine{00146\ \};}
\DoxyCodeLine{00147\ }
\DoxyCodeLine{00148\ TEST\_F(XmlOutputChangeDirTest,\ PreserveOriginalWorkingDirWithDefault)\ \{}
\DoxyCodeLine{00149\ \ \ GTEST\_FLAG\_SET(output,\ \textcolor{stringliteral}{"{}"{}});}
\DoxyCodeLine{00150\ \ \ EXPECT\_EQ(}
\DoxyCodeLine{00151\ \ \ \ \ \ \ FilePath::ConcatPaths(original\_working\_dir\_,\ FilePath(\textcolor{stringliteral}{"{}test\_detail.xml"{}}))}
\DoxyCodeLine{00152\ \ \ \ \ \ \ \ \ \ \ .\textcolor{keywordtype}{string}(),}
\DoxyCodeLine{00153\ \ \ \ \ \ \ UnitTestOptions::GetAbsolutePathToOutputFile());}
\DoxyCodeLine{00154\ \}}
\DoxyCodeLine{00155\ }
\DoxyCodeLine{00156\ TEST\_F(XmlOutputChangeDirTest,\ PreserveOriginalWorkingDirWithDefaultXML)\ \{}
\DoxyCodeLine{00157\ \ \ GTEST\_FLAG\_SET(output,\ \textcolor{stringliteral}{"{}xml"{}});}
\DoxyCodeLine{00158\ \ \ EXPECT\_EQ(}
\DoxyCodeLine{00159\ \ \ \ \ \ \ FilePath::ConcatPaths(original\_working\_dir\_,\ FilePath(\textcolor{stringliteral}{"{}test\_detail.xml"{}}))}
\DoxyCodeLine{00160\ \ \ \ \ \ \ \ \ \ \ .\textcolor{keywordtype}{string}(),}
\DoxyCodeLine{00161\ \ \ \ \ \ \ UnitTestOptions::GetAbsolutePathToOutputFile());}
\DoxyCodeLine{00162\ \}}
\DoxyCodeLine{00163\ }
\DoxyCodeLine{00164\ TEST\_F(XmlOutputChangeDirTest,\ PreserveOriginalWorkingDirWithRelativeFile)\ \{}
\DoxyCodeLine{00165\ \ \ GTEST\_FLAG\_SET(output,\ \textcolor{stringliteral}{"{}xml:filename.abc"{}});}
\DoxyCodeLine{00166\ \ \ EXPECT\_EQ(}
\DoxyCodeLine{00167\ \ \ \ \ \ \ FilePath::ConcatPaths(original\_working\_dir\_,\ FilePath(\textcolor{stringliteral}{"{}filename.abc"{}}))}
\DoxyCodeLine{00168\ \ \ \ \ \ \ \ \ \ \ .\textcolor{keywordtype}{string}(),}
\DoxyCodeLine{00169\ \ \ \ \ \ \ UnitTestOptions::GetAbsolutePathToOutputFile());}
\DoxyCodeLine{00170\ \}}
\DoxyCodeLine{00171\ }
\DoxyCodeLine{00172\ TEST\_F(XmlOutputChangeDirTest,\ PreserveOriginalWorkingDirWithRelativePath)\ \{}
\DoxyCodeLine{00173\ \ \ GTEST\_FLAG\_SET(output,\ \textcolor{stringliteral}{"{}xml:path"{}}\ GTEST\_PATH\_SEP\_);}
\DoxyCodeLine{00174\ \ \ \textcolor{keyword}{const}\ std::string\ expected\_output\_file\ =}
\DoxyCodeLine{00175\ \ \ \ \ \ \ FilePath::ConcatPaths(}
\DoxyCodeLine{00176\ \ \ \ \ \ \ \ \ \ \ original\_working\_dir\_,}
\DoxyCodeLine{00177\ \ \ \ \ \ \ \ \ \ \ FilePath(std::string(\textcolor{stringliteral}{"{}path"{}})\ +\ GTEST\_PATH\_SEP\_\ +}
...
\DoxyCodeLine{00181\ \ \ \ \ \ \ UnitTestOptions::GetAbsolutePathToOutputFile();}
\DoxyCodeLine{00182\ \textcolor{preprocessor}{\#ifdef\ GTEST\_OS\_WINDOWS}}
\DoxyCodeLine{00183\ \ \ EXPECT\_STRCASEEQ(expected\_output\_file.c\_str(),\ output\_file.c\_str());}
\DoxyCodeLine{00184\ \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{00185\ \ \ EXPECT\_EQ(expected\_output\_file,\ output\_file.c\_str());}
\DoxyCodeLine{00186\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00187\ \}}
\DoxyCodeLine{00188\ }
\DoxyCodeLine{00189\ TEST\_F(XmlOutputChangeDirTest,\ PreserveOriginalWorkingDirWithAbsoluteFile)\ \{}
\DoxyCodeLine{00190\ \textcolor{preprocessor}{\#ifdef\ GTEST\_OS\_WINDOWS}}
\DoxyCodeLine{00191\ \ \ GTEST\_FLAG\_SET(output,\ \textcolor{stringliteral}{"{}xml:c:\(\backslash\)\(\backslash\)tmp\(\backslash\)\(\backslash\)filename.abc"{}});}
\DoxyCodeLine{00192\ \ \ EXPECT\_EQ(FilePath(\textcolor{stringliteral}{"{}c:\(\backslash\)\(\backslash\)tmp\(\backslash\)\(\backslash\)filename.abc"{}}).\textcolor{keywordtype}{string}(),}
\DoxyCodeLine{00193\ \ \ \ \ \ \ \ \ \ \ \ \ UnitTestOptions::GetAbsolutePathToOutputFile());}
\DoxyCodeLine{00194\ \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{00195\ \ \ GTEST\_FLAG\_SET(output,\ \textcolor{stringliteral}{"{}xml:/tmp/filename.abc"{}});}
\DoxyCodeLine{00196\ \ \ EXPECT\_EQ(FilePath(\textcolor{stringliteral}{"{}/tmp/filename.abc"{}}).\textcolor{keywordtype}{string}(),}
\DoxyCodeLine{00197\ \ \ \ \ \ \ \ \ \ \ \ \ UnitTestOptions::GetAbsolutePathToOutputFile());}
\DoxyCodeLine{00198\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00199\ \}}
\DoxyCodeLine{00200\ }
\DoxyCodeLine{00201\ TEST\_F(XmlOutputChangeDirTest,\ PreserveOriginalWorkingDirWithAbsolutePath)\ \{}
...
\DoxyCodeLine{00207\ }
\DoxyCodeLine{00208\ \ \ GTEST\_FLAG\_SET(output,\ \textcolor{stringliteral}{"{}xml:"{}}\ +\ path);}
...
\DoxyCodeLine{00212\ \ \ \ \ \ \ UnitTestOptions::GetAbsolutePathToOutputFile();}
\DoxyCodeLine{00213\ }
\DoxyCodeLine{00214\ \textcolor{preprocessor}{\#ifdef\ GTEST\_OS\_WINDOWS}}
\DoxyCodeLine{00215\ \ \ EXPECT\_STRCASEEQ(expected\_output\_file.c\_str(),\ output\_file.c\_str());}
\DoxyCodeLine{00216\ \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{00217\ \ \ EXPECT\_EQ(expected\_output\_file,\ output\_file.c\_str());}
