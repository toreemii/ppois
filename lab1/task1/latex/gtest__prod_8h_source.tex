...
\hypertarget{gtest__prod_8h_source}{}\label{gtest__prod_8h_source}\index{googletest/googletest/include/gtest/gtest\_prod.h@{googletest/googletest/include/gtest/gtest\_prod.h}}
...
\DoxyCodeLine{00029\ }
\DoxyCodeLine{00030\ \textcolor{comment}{//\ Google\ C++\ Testing\ and\ Mocking\ Framework\ definitions\ useful\ in\ production}}
\DoxyCodeLine{00031\ \textcolor{comment}{//\ code.}}
\DoxyCodeLine{00032\ }
\DoxyCodeLine{00033\ \textcolor{preprocessor}{\#ifndef\ GOOGLETEST\_INCLUDE\_GTEST\_GTEST\_PROD\_H\_}}
\DoxyCodeLine{00034\ \textcolor{preprocessor}{\#define\ GOOGLETEST\_INCLUDE\_GTEST\_GTEST\_PROD\_H\_}}
\DoxyCodeLine{00035\ }
\DoxyCodeLine{00036\ \textcolor{comment}{//\ When\ you\ need\ to\ test\ the\ private\ or\ protected\ members\ of\ a\ class,}}
\DoxyCodeLine{00037\ \textcolor{comment}{//\ use\ the\ FRIEND\_TEST\ macro\ to\ declare\ your\ tests\ as\ friends\ of\ the}}
\DoxyCodeLine{00038\ \textcolor{comment}{//\ class.\ \ For\ example:}}
\DoxyCodeLine{00039\ \textcolor{comment}{//}}
\DoxyCodeLine{00040\ \textcolor{comment}{//\ class\ MyClass\ \{}}
\DoxyCodeLine{00041\ \textcolor{comment}{//\ \ private:}}
\DoxyCodeLine{00042\ \textcolor{comment}{//\ \ \ void\ PrivateMethod();}}
\DoxyCodeLine{00043\ \textcolor{comment}{//\ \ \ FRIEND\_TEST(MyClassTest,\ PrivateMethodWorks);}}
\DoxyCodeLine{00044\ \textcolor{comment}{//\ \};}}
\DoxyCodeLine{00045\ \textcolor{comment}{//}}
\DoxyCodeLine{00046\ \textcolor{comment}{//\ class\ MyClassTest\ :\ public\ testing::Test\ \{}}
\DoxyCodeLine{00047\ \textcolor{comment}{//\ \ \ //\ ...}}
\DoxyCodeLine{00048\ \textcolor{comment}{//\ \};}}
\DoxyCodeLine{00049\ \textcolor{comment}{//}}
\DoxyCodeLine{00050\ \textcolor{comment}{//\ TEST\_F(MyClassTest,\ PrivateMethodWorks)\ \{}}
\DoxyCodeLine{00051\ \textcolor{comment}{//\ \ \ //\ Can\ call\ MyClass::PrivateMethod()\ here.}}
\DoxyCodeLine{00052\ \textcolor{comment}{//\ \}}}
\DoxyCodeLine{00053\ \textcolor{comment}{//}}
\DoxyCodeLine{00054\ \textcolor{comment}{//\ Note:\ The\ test\ class\ must\ be\ in\ the\ same\ namespace\ as\ the\ class\ being\ tested.}}
\DoxyCodeLine{00055\ \textcolor{comment}{//\ For\ example,\ putting\ MyClassTest\ in\ an\ anonymous\ namespace\ will\ not\ work.}}
\DoxyCodeLine{00056\ }
\DoxyCodeLine{00057\ \textcolor{preprocessor}{\#define\ FRIEND\_TEST(test\_case\_name,\ test\_name)\ \(\backslash\)}}
\DoxyCodeLine{00058\ \textcolor{preprocessor}{\ \ friend\ class\ test\_case\_name\#\#\_\#\#test\_name\#\#\_Test}}
\DoxyCodeLine{00059\ }
\DoxyCodeLine{00060\ \textcolor{preprocessor}{\#endif\ \ }\textcolor{comment}{//\ GOOGLETEST\_INCLUDE\_GTEST\_GTEST\_PROD\_H\_}}
