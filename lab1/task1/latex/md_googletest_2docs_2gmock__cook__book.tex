...
\hypertarget{md_googletest_2docs_2gmock__cook__book}{}\label{md_googletest_2docs_2gmock__cook__book}\index{gMock Cookbook@{gMock Cookbook}}
\label{md_googletest_2docs_2gmock__cook__book_autotoc_md118}%
\Hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md118}%
 You can find recipes for using g\+Mock here. If you haven\textquotesingle{}t yet, please read \doxysectlink{md_googletest_2docs_2gmock__for__dummies}{the dummy guide}{0} first to make sure you understand the basics.

\{\+: .callout .note\} {\bfseries{Note\+:}} g\+Mock lives in the {\ttfamily testing} name space. For readability, it is recommended to write {\ttfamily using \+::testing\+::\+Foo;} once in your file before using the name {\ttfamily Foo} defined by g\+Mock. We omit such {\ttfamily using} statements in this section for brevity, but you should do it in your own code.\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md119}{}\doxysection{\texorpdfstring{Creating Mock Classes}{Creating Mock Classes}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md119}
\doxylink{classMock}{Mock} classes are defined as normal classes, using the {\ttfamily MOCK\+\_\+\+METHOD} macro to generate mocked methods. The macro gets 3 or 4 parameters\+:
...
\end{DoxyItemize}\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md120}{}\doxysubsection{\texorpdfstring{Dealing with unprotected commas}{Dealing with unprotected commas}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md120}
...
\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md121}{}\doxysubsection{\texorpdfstring{Mocking Private or Protected Methods}{Mocking Private or Protected Methods}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md121}
...
\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md122}{}\doxysubsection{\texorpdfstring{Mocking Overloaded Methods}{Mocking Overloaded Methods}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md122}
...
\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md123}{}\doxysubsection{\texorpdfstring{Mocking Class Templates}{Mocking Class Templates}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md123}
...
\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_MockingNonVirtualMethods}{}\doxysubsection{\texorpdfstring{Mocking Non-\/virtual Methods}{Mocking Non-virtual Methods}}\label{md_googletest_2docs_2gmock__cook__book_MockingNonVirtualMethods}
...
\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md124}{}\doxysubsection{\texorpdfstring{Mocking Free Functions}{Mocking Free Functions}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md124}
...
If you are concerned about the performance overhead incurred by virtual functions, and profiling confirms your concern, you can combine this with the recipe for \doxysectlink{md_googletest_2docs_2gmock__cook__book_MockingNonVirtualMethods}{mocking non-\/virtual methods}{2}.

Alternatively, instead of introducing a new interface, you can rewrite your code to accept a std\+::function instead of the free function, and then use \doxysectlink{md_googletest_2docs_2gmock__cook__book_MockFunction}{Mock\+Function}{2} to mock the std\+::function.\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md125}{}\doxysubsection{\texorpdfstring{Old-\/\+Style $<$tt$>$\+MOCK\+\_\+\+METHODn$<$/tt$>$ Macros}{Old-Style <tt>MOCK\_METHODn</tt> Macros}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md125}
...
\end{longtabu}
\hypertarget{md_googletest_2docs_2gmock__cook__book_NiceStrictNaggy}{}\doxysubsection{\texorpdfstring{The Nice, the Strict, and the Naggy}{The Nice, the Strict, and the Naggy}}\label{md_googletest_2docs_2gmock__cook__book_NiceStrictNaggy}
...
Suppose your test uses a mock class {\ttfamily \doxylink{classMockFoo}{Mock\+Foo}}\+:
...
If a method of {\ttfamily mock\+\_\+foo} other than {\ttfamily Do\+This()} is called, you will get a warning. However, if you rewrite your test to use {\ttfamily Nice\+Mock\texorpdfstring{$<$}{<}\doxylink{classMockFoo}{Mock\+Foo}\texorpdfstring{$>$}{>}} instead, you can suppress the warning\+:
...
{\ttfamily Nice\+Mock\texorpdfstring{$<$}{<}\doxylink{classMockFoo}{Mock\+Foo}\texorpdfstring{$>$}{>}} is a subclass of {\ttfamily \doxylink{classMockFoo}{Mock\+Foo}}, so it can be used wherever {\ttfamily \doxylink{classMockFoo}{Mock\+Foo}} is accepted.

It also works if {\ttfamily \doxylink{classMockFoo}{Mock\+Foo}}\textquotesingle{}s constructor takes some arguments, as {\ttfamily Nice\+Mock\texorpdfstring{$<$}{<}\doxylink{classMockFoo}{Mock\+Foo}\texorpdfstring{$>$}{>}} "{}inherits"{} {\ttfamily \doxylink{classMockFoo}{Mock\+Foo}}\textquotesingle{}s constructors\+:
...
\{\+: .callout .note\} NOTE\+: {\ttfamily Nice\+Mock} and {\ttfamily Strict\+Mock} only affects {\itshape uninteresting} calls (calls of {\itshape methods} with no expectations); they do not affect {\itshape unexpected} calls (calls of methods with expectations, but they don\textquotesingle{}t match). See \doxysectlink{md_googletest_2docs_2gmock__cook__book_uninteresting-vs-unexpected}{Understanding Uninteresting vs Unexpected Calls}{2}.

There are some caveats though (sadly they are side effects of C++\textquotesingle{}s limitations)\+:


\begin{DoxyEnumerate}
\item {\ttfamily Nice\+Mock\texorpdfstring{$<$}{<}\doxylink{classMockFoo}{Mock\+Foo}\texorpdfstring{$>$}{>}} and {\ttfamily Strict\+Mock\texorpdfstring{$<$}{<}\doxylink{classMockFoo}{Mock\+Foo}\texorpdfstring{$>$}{>}} only work for mock methods defined using the {\ttfamily MOCK\+\_\+\+METHOD} macro {\bfseries{directly}} in the {\ttfamily \doxylink{classMockFoo}{Mock\+Foo}} class. If a mock method is defined in a {\bfseries{base class}} of {\ttfamily \doxylink{classMockFoo}{Mock\+Foo}}, the "{}nice"{} or "{}strict"{} modifier may not affect it, depending on the compiler. In particular, nesting {\ttfamily Nice\+Mock} and {\ttfamily Strict\+Mock} (e.\+g. {\ttfamily Nice\+Mock\texorpdfstring{$<$}{<}Strict\+Mock\texorpdfstring{$<$}{<}\doxylink{classMockFoo}{Mock\+Foo}\texorpdfstring{$>$}{>} \texorpdfstring{$>$}{>}}) is {\bfseries{not}} supported.
\item {\ttfamily Nice\+Mock\texorpdfstring{$<$}{<}\doxylink{classMockFoo}{Mock\+Foo}\texorpdfstring{$>$}{>}} and {\ttfamily Strict\+Mock\texorpdfstring{$<$}{<}\doxylink{classMockFoo}{Mock\+Foo}\texorpdfstring{$>$}{>}} may not work correctly if the destructor of {\ttfamily \doxylink{classMockFoo}{Mock\+Foo}} is not virtual. We would like to fix this, but it requires cleaning up existing tests.
\end{DoxyEnumerate}

Finally, you should be {\bfseries{very cautious}} about when to use naggy or strict mocks, as they tend to make tests more brittle and harder to maintain. When you refactor your code without changing its externally visible behavior, ideally you shouldn\textquotesingle{}t need to update any tests. If your code interacts with a naggy mock, however, you may start to get spammed with warnings as the result of your change. Worse, if your code interacts with a strict mock, your tests may start to fail and you\textquotesingle{}ll be forced to fix them. Our general recommendation is to use nice mocks (not yet the default) most of the time, use naggy mocks (the current default) when developing or debugging tests, and use strict mocks only as the last resort.\hypertarget{md_googletest_2docs_2gmock__cook__book_SimplerInterfaces}{}\doxysubsection{\texorpdfstring{Simplifying the Interface without Breaking Existing Code}{Simplifying the Interface without Breaking Existing Code}}\label{md_googletest_2docs_2gmock__cook__book_SimplerInterfaces}
...
\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md126}{}\doxysubsection{\texorpdfstring{Alternative to Mocking Concrete Classes}{Alternative to Mocking Concrete Classes}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md126}
...
You need to weigh the pros and cons carefully for your particular problem, but I\textquotesingle{}d like to assure you that the Java community has been practicing this for a long time and it\textquotesingle{}s a proven effective technique applicable in a wide variety of situations. \+:-\/)\hypertarget{md_googletest_2docs_2gmock__cook__book_DelegatingToFake}{}\doxysubsection{\texorpdfstring{Delegating Calls to a Fake}{Delegating Calls to a Fake}}\label{md_googletest_2docs_2gmock__cook__book_DelegatingToFake}
...
With that, you can use {\ttfamily \doxylink{classMockFoo}{Mock\+Foo}} in your tests as usual. Just remember that if you don\textquotesingle{}t explicitly set an action in an {\ttfamily ON\+\_\+\+CALL()} or {\ttfamily EXPECT\+\_\+\+CALL()}, the fake will be called upon to do it.\+:
...
\DoxyCodeLine{\ \ EXPECT\_EQ(foo.DoThis(5),\ \textcolor{charliteral}{'+'});\ \ \textcolor{comment}{//\ FakeFoo::DoThis()\ is\ invoked.}}
...
Instead, you can define a {\ttfamily File\+Ops} interface and an {\ttfamily IOOps} interface and split {\ttfamily System}\textquotesingle{}s functionalities into the two. Then you can mock {\ttfamily IOOps} without mocking {\ttfamily File\+Ops}.\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md127}{}\doxysubsection{\texorpdfstring{Delegating Calls to a Real Object}{Delegating Calls to a Real Object}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md127}
...
You can use the {\itshape delegating-\/to-\/real} technique to ensure that your mock has the same behavior as the real object while retaining the ability to validate calls. This technique is very similar to the \doxysectlink{md_googletest_2docs_2gmock__cook__book_DelegatingToFake}{delegating-\/to-\/fake}{2} technique, the difference being that we use a real object instead of a fake. Here\textquotesingle{}s an example\+:
...
(Why don\textquotesingle{}t we just write {\ttfamily \{ return foo.\+Concrete(str); \}}? If you do that, {\ttfamily Mock\+Foo\+::\+Concrete()} will be called (and cause an infinite recursion) since {\ttfamily Foo\+::\+Concrete()} is virtual. That\textquotesingle{}s just how C++ works.)\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md129}{}\doxysection{\texorpdfstring{Using Matchers}{Using Matchers}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md129}
\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md130}{}\doxysubsection{\texorpdfstring{Matching Argument Values Exactly}{Matching Argument Values Exactly}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md130}
...
\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md131}{}\doxysubsection{\texorpdfstring{Using Simple Matchers}{Using Simple Matchers}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md131}
...
\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_CombiningMatchers}{}\doxysubsection{\texorpdfstring{Combining Matchers}{Combining Matchers}}\label{md_googletest_2docs_2gmock__cook__book_CombiningMatchers}
...
\DoxyCodeLine{\ \ \textcolor{keywordflow}{return}\ Property(\textcolor{stringliteral}{"{}foo"{}},\ \&MyClass::foo,\ Contains(f));}
\DoxyCodeLine{\};}
\DoxyCodeLine{...}
\DoxyCodeLine{\ \ EXPECT\_THAT(x,\ HasFoo(\textcolor{stringliteral}{"{}blah"{}}));}

\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_SafeMatcherCast}{}\doxysubsection{\texorpdfstring{Casting Matchers}{Casting Matchers}}\label{md_googletest_2docs_2gmock__cook__book_SafeMatcherCast}
...
\item When {\ttfamily U} is a non-\/const reference, {\ttfamily T} must also be a reference (as the underlying matcher may be interested in the address of the {\ttfamily U} value).
\end{DoxyEnumerate}
...
{\ttfamily Matcher\+Cast} essentially lets you bypass C++\textquotesingle{}s type system ({\ttfamily static\+\_\+cast} isn\textquotesingle{}t always safe as it could throw away information, for example), so be careful not to misuse/abuse it.\hypertarget{md_googletest_2docs_2gmock__cook__book_SelectOverload}{}\doxysubsection{\texorpdfstring{Selecting Between Overloaded Functions}{Selecting Between Overloaded Functions}}\label{md_googletest_2docs_2gmock__cook__book_SelectOverload}
...
\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md132}{}\doxysubsection{\texorpdfstring{Performing Different Actions Based on the Arguments}{Performing Different Actions Based on the Arguments}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md132}
...
Now, if {\ttfamily foo.\+Do\+This()} is called with a value less than 5, `\textquotesingle{}a'{\ttfamily will be returned; otherwise}\textquotesingle{}b\textquotesingle{}\`{} will be returned.\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md133}{}\doxysubsection{\texorpdfstring{Matching Multiple Arguments as a Whole}{Matching Multiple Arguments as a Whole}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md133}
...
Note that if you want to pass the arguments to a predicate of your own (e.\+g. {\ttfamily .With(Args\texorpdfstring{$<$}{<}0, 1\texorpdfstring{$>$}{>}(Truly(\&My\+Predicate)))}), that predicate MUST be written to take a {\ttfamily std\+::tuple} as its argument; g\+Mock will pass the {\ttfamily n} selected arguments as {\itshape one} single tuple to the predicate.\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md134}{}\doxysubsection{\texorpdfstring{Using Matchers as Predicates}{Using Matchers as Predicates}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md134}
...
\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md135}{}\doxysubsection{\texorpdfstring{Using Matchers in googletest Assertions}{Using Matchers in googletest Assertions}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md135}
See \href{reference/assertions.md\#EXPECT_THAT}{\texttt{ {\ttfamily EXPECT\+\_\+\+THAT}}} in the Assertions Reference.\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md136}{}\doxysubsection{\texorpdfstring{Using Predicates as Matchers}{Using Predicates as Matchers}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md136}
g\+Mock provides a set of built-\/in matchers for matching arguments with expected values—see the \doxysectlink{md_googletest_2docs_2reference_2matchers}{Matchers Reference}{0} for more information. In case you find the built-\/in set lacking, you can use an arbitrary unary predicate function or functor as a matcher -\/ as long as the predicate accepts a value of the type you want. You do this by wrapping the predicate inside the {\ttfamily Truly()} function, for example\+:
...
Note that the predicate function / functor doesn\textquotesingle{}t have to return {\ttfamily bool}. It works as long as the return value can be used as the condition in the statement {\ttfamily if (condition) ...}.\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md137}{}\doxysubsection{\texorpdfstring{Matching Arguments that Are Not Copyable}{Matching Arguments that Are Not Copyable}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md137}
...
Remember\+: if you do this, don\textquotesingle{}t change {\ttfamily bar} after the {\ttfamily EXPECT\+\_\+\+CALL()}, or the result is undefined.\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md138}{}\doxysubsection{\texorpdfstring{Validating a Member of an Object}{Validating a Member of an Object}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md138}
...
What if you want to validate more than one members at the same time? Remember that there are \doxysectlink{md_googletest_2docs_2gmock__cook__book_CombiningMatchers}{\`{}\+All\+Of()\`{} and \`{}\+All\+Of\+Array()\`{}}{2}.
...
\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md139}{}\doxysubsection{\texorpdfstring{Validating the Value Pointed to by a Pointer Argument}{Validating the Value Pointed to by a Pointer Argument}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md139}
...
What if you have a pointer to pointer? You guessed it -\/ you can use nested {\ttfamily Pointee()} to probe deeper inside the value. For example, {\ttfamily Pointee(Pointee(\+Lt(3)))} matches a pointer that points to a pointer that points to a number less than 3 (what a mouthful...).\hypertarget{md_googletest_2docs_2gmock__cook__book_CustomMatcherClass}{}\doxysubsection{\texorpdfstring{Defining a Custom Matcher Class}{Defining a Custom Matcher Class}}\label{md_googletest_2docs_2gmock__cook__book_CustomMatcherClass}
Most matchers can be simply defined using \doxysectlink{md_googletest_2docs_2gmock__cook__book_NewMatchers}{the MATCHER\texorpdfstring{$\ast$}{*} macros}{2}, which are terse and flexible, and produce good error messages. However, these macros are not very explicit about the interfaces they create and are not always suitable, especially for matchers that will be widely reused.
...
\DoxyCodeLine{\};}
\DoxyCodeLine{}
\DoxyCodeLine{\mbox{\hyperlink{classtesting_1_1Matcher}{::testing::Matcher<const\ Foo\&>}}\ BarPlusBazEq(\textcolor{keywordtype}{int}\ expected\_sum)\ \{}
\DoxyCodeLine{\ \ \textcolor{keywordflow}{return}\ BarPlusBazEqMatcher(expected\_sum);}
\DoxyCodeLine{\}}
\DoxyCodeLine{}
\DoxyCodeLine{...}
\DoxyCodeLine{\ \ Foo\ foo;}
\DoxyCodeLine{\ \ EXPECT\_THAT(foo,\ BarPlusBazEq(5))...;}

\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md140}{}\doxysubsection{\texorpdfstring{Matching Containers}{Matching Containers}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md140}
...
\end{DoxyItemize}\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md141}{}\doxysubsection{\texorpdfstring{Sharing Matchers}{Sharing Matchers}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md141}
...
\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_PureMatchers}{}\doxysubsection{\texorpdfstring{Matchers must have no side-\/effects}{Matchers must have no side-effects}}\label{md_googletest_2docs_2gmock__cook__book_PureMatchers}
...
This requirement must be satisfied no matter how a matcher is defined (e.\+g., if it is one of the standard matchers, or a custom matcher). In particular, a matcher can never call a mock function, as that will affect the state of the mock object and g\+Mock.\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md142}{}\doxysection{\texorpdfstring{Setting Expectations}{Setting Expectations}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md142}
\hypertarget{md_googletest_2docs_2gmock__cook__book_UseOnCall}{}\doxysubsection{\texorpdfstring{Knowing When to Expect}{Knowing When to Expect}}\label{md_googletest_2docs_2gmock__cook__book_UseOnCall}
...
If you are bothered by the "{}\+Uninteresting mock function call"{} message printed when a mock method without an {\ttfamily EXPECT\+\_\+\+CALL} is called, you may use a {\ttfamily Nice\+Mock} instead to suppress all such messages for the mock object, or suppress the message for specific methods by adding {\ttfamily EXPECT\+\_\+\+CALL(...).Times(\+Any\+Number())}. DO NOT suppress it by blindly adding an {\ttfamily EXPECT\+\_\+\+CALL(...)}, or you\textquotesingle{}ll have a test that\textquotesingle{}s a pain to maintain.\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md143}{}\doxysubsection{\texorpdfstring{Ignoring Uninteresting Calls}{Ignoring Uninteresting Calls}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md143}
If you are not interested in how a mock method is called, just don\textquotesingle{}t say anything about it. In this case, if the method is ever called, g\+Mock will perform its default action to allow the test program to continue. If you are not happy with the default action taken by g\+Mock, you can override it using {\ttfamily Default\+Value\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}::Set()} (described \doxysectlink{md_googletest_2docs_2reference_2mocking_DefaultValue}{here}{2}) or {\ttfamily ON\+\_\+\+CALL()}.

Please note that once you expressed interest in a particular mock method (via {\ttfamily EXPECT\+\_\+\+CALL()}), all invocations to it must match some expectation. If this function is called but the arguments don\textquotesingle{}t match any {\ttfamily EXPECT\+\_\+\+CALL()} statement, it will be an error.\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md144}{}\doxysubsection{\texorpdfstring{Disallowing Unexpected Calls}{Disallowing Unexpected Calls}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md144}
...
A call to {\ttfamily foo.\+Bar()} that doesn\textquotesingle{}t match any of the {\ttfamily EXPECT\+\_\+\+CALL()} statements will be an error.\hypertarget{md_googletest_2docs_2gmock__cook__book_uninteresting-vs-unexpected}{}\doxysubsection{\texorpdfstring{Understanding Uninteresting vs Unexpected Calls}{Understanding Uninteresting vs Unexpected Calls}}\label{md_googletest_2docs_2gmock__cook__book_uninteresting-vs-unexpected}
...
For more on uninteresting calls, nice mocks, and strict mocks, read \doxysectlink{md_googletest_2docs_2gmock__cook__book_NiceStrictNaggy}{"{}The Nice, the Strict, and the Naggy"{}}{2}.\hypertarget{md_googletest_2docs_2gmock__cook__book_ParameterlessExpectations}{}\doxysubsection{\texorpdfstring{Ignoring Uninteresting Arguments}{Ignoring Uninteresting Arguments}}\label{md_googletest_2docs_2gmock__cook__book_ParameterlessExpectations}
...
This functionality is only available when a method is not overloaded; to prevent unexpected behavior it is a compilation error to try to set an expectation on a method where the specific overload is ambiguous. You can work around this by supplying a \doxysectlink{md_googletest_2docs_2gmock__cook__book_SimplerInterfaces}{simpler mock interface}{2} than the mocked class provides.

This pattern is also useful when the arguments are interesting, but match logic is substantially complex. You can leave the argument list unspecified and use Save\+Arg actions to \doxysectlink{md_googletest_2docs_2gmock__cook__book_SaveArgVerify}{save the values for later verification}{2}. If you do that, you can easily differentiate calling the method the wrong number of times from calling it with the wrong arguments.\hypertarget{md_googletest_2docs_2gmock__for__dummies_OrderedCalls}{}\doxysubsection{\texorpdfstring{Expecting Ordered Calls}{Expecting Ordered Calls}}\label{md_googletest_2docs_2gmock__for__dummies_OrderedCalls}
...
In this example, we expect a call to {\ttfamily foo.\+Do\+This(5)}, followed by two calls to {\ttfamily bar.\+Do\+That()} where the argument can be anything, which are in turn followed by a call to {\ttfamily foo.\+Do\+This(6)}. If a call occurred out-\/of-\/order, g\+Mock will report an error.\hypertarget{md_googletest_2docs_2gmock__cook__book_PartialOrder}{}\doxysubsection{\texorpdfstring{Expecting Partially Ordered Calls}{Expecting Partially Ordered Calls}}\label{md_googletest_2docs_2gmock__cook__book_PartialOrder}
...
This means that A must occur before B and C, and C must occur before D. There\textquotesingle{}s no restriction about the order other than these.\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md145}{}\doxysubsection{\texorpdfstring{Controlling When an Expectation Retires}{Controlling When an Expectation Retires}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md145}
...
Here \#2 can be used only once, so if you have two warnings with the message {\ttfamily "{}\+File too large."{}}, the first will match \#2 and the second will match \#1 -\/ there will be no error.\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md146}{}\doxysection{\texorpdfstring{Using Actions}{Using Actions}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md146}
\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md147}{}\doxysubsection{\texorpdfstring{Returning References from Mock Methods}{Returning References from Mock Methods}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md147}
...
\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md148}{}\doxysubsection{\texorpdfstring{Returning Live Values from Mock Methods}{Returning Live Values from Mock Methods}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md148}
...
\DoxyCodeLine{\ \ x\ =\ 42;}
\DoxyCodeLine{\ \ EXPECT\_EQ(foo.GetValue(),\ 42);}
...
\DoxyCodeLine{\ \ x\ =\ 42;}
\DoxyCodeLine{\ \ EXPECT\_EQ(foo.GetValue(),\ 42);\ \ \textcolor{comment}{//\ This\ will\ succeed\ now.}}

\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md149}{}\doxysubsection{\texorpdfstring{Combining Actions}{Combining Actions}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md149}
...
\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_MockingSideEffects}{}\doxysubsection{\texorpdfstring{Mocking Side Effects}{Mocking Side Effects}}\label{md_googletest_2docs_2gmock__cook__book_MockingSideEffects}
Sometimes a method exhibits its effect not via returning a value but via side effects. For example, it may change some global state or modify an output argument. To mock side effects, in general you can define your own action by implementing {\ttfamily \doxylink{classtesting_1_1ActionInterface}{testing\+::\+Action\+Interface}}.
...
\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md150}{}\doxysubsection{\texorpdfstring{Changing a Mock Object\textquotesingle{}s Behavior Based on the State}{Changing a Mock Object's Behavior Based on the State}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md150}
...
Here {\ttfamily my\+\_\+mock.\+Get\+Prev\+Value()} will always return the argument of the last {\ttfamily Update\+Value()} call.\hypertarget{md_googletest_2docs_2reference_2mocking_DefaultValue}{}\doxysubsection{\texorpdfstring{Setting the Default Value for a Return Type}{Setting the Default Value for a Return Type}}\label{md_googletest_2docs_2reference_2mocking_DefaultValue}
...
Sometimes, you may want to change this default value, or you may want to specify a default value for types g\+Mock doesn\textquotesingle{}t know about. You can do this using the {\ttfamily \doxylink{classtesting_1_1DefaultValue}{testing\+::\+Default\+Value}} class template\+:
...
Please note that changing the default value for a type can make your tests hard to understand. We recommend you to use this feature judiciously. For example, you may want to make sure the {\ttfamily Set()} and {\ttfamily Clear()} calls are right next to the code that uses your mock.\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md151}{}\doxysubsection{\texorpdfstring{Setting the Default Actions for a Mock Method}{Setting the Default Actions for a Mock Method}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md151}
...
Note that both {\ttfamily ON\+\_\+\+CALL} and {\ttfamily EXPECT\+\_\+\+CALL} have the same "{}later statements take precedence"{} rule, but they don\textquotesingle{}t interact. That is, {\ttfamily EXPECT\+\_\+\+CALL}s have their own precedence order distinct from the {\ttfamily ON\+\_\+\+CALL} precedence order.\hypertarget{md_googletest_2docs_2gmock__cook__book_FunctionsAsActions}{}\doxysubsection{\texorpdfstring{Using Functions/\+Methods/\+Functors/\+Lambdas as Actions}{Using Functions/Methods/Functors/Lambdas as Actions}}\label{md_googletest_2docs_2gmock__cook__book_FunctionsAsActions}
...
\end{DoxyItemize}\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md152}{}\doxysubsection{\texorpdfstring{Using Functions with Extra Info as Actions}{Using Functions with Extra Info as Actions}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md152}
...
\DoxyCodeLine{\ \ EXPECT\_EQ(foo.DoThis(2),\ \textcolor{charliteral}{'+'});\ \ \textcolor{comment}{//\ Invokes\ SignOfSum(5,\ 2).}}
\DoxyCodeLine{\}}

\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md153}{}\doxysubsection{\texorpdfstring{Invoking a Function/\+Method/\+Functor/\+Lambda/\+Callback Without Arguments}{Invoking a Function/Method/Functor/Lambda/Callback Without Arguments}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md153}
...
\end{DoxyItemize}\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md154}{}\doxysubsection{\texorpdfstring{Invoking an Argument of the Mock Function}{Invoking an Argument of the Mock Function}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md154}
...
\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md155}{}\doxysubsection{\texorpdfstring{Ignoring an Action\textquotesingle{}s Result}{Ignoring an Action's Result}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md155}
...
Note that you {\bfseries{cannot}} use {\ttfamily Ignore\+Result()} on an action that already returns {\ttfamily void}. Doing so will lead to ugly compiler errors.\hypertarget{md_googletest_2docs_2gmock__cook__book_SelectingArgs}{}\doxysubsection{\texorpdfstring{Selecting an Action\textquotesingle{}s Arguments}{Selecting an Action's Arguments}}\label{md_googletest_2docs_2gmock__cook__book_SelectingArgs}
...
\end{DoxyItemize}\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md156}{}\doxysubsection{\texorpdfstring{Ignoring Arguments in Action Functions}{Ignoring Arguments in Action Functions}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md156}
The \doxysectlink{md_googletest_2docs_2gmock__cook__book_SelectingArgs}{selecting-\/an-\/action\textquotesingle{}s-\/arguments}{2} recipe showed us one way to make a mock function and an action with incompatible argument lists fit together. The downside is that wrapping the action in {\ttfamily With\+Args\texorpdfstring{$<$}{<}...\texorpdfstring{$>$}{>}()} can get tedious for people writing the tests.
...
\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md157}{}\doxysubsection{\texorpdfstring{Sharing Actions}{Sharing Actions}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md157}
...
\DoxyCodeLine{foo.DoThat();\ \ \textcolor{comment}{//\ Returns\ 1\ -\/\ DoThat()\ uses\ a\ different}}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ counter\ than\ DoThis()'s.}}
...
\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md158}{}\doxysubsection{\texorpdfstring{Testing Asynchronous Behavior}{Testing Asynchronous Behavior}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md158}
...
\{\+: .callout .note\} Note\+: this example has a downside\+: namely, if the expectation is not satisfied, our test will run forever. It will eventually time-\/out and fail, but it will take longer and be slightly harder to debug. To alleviate this problem, you can use {\ttfamily Wait\+For\+Notification\+With\+Timeout(ms)} instead of {\ttfamily Wait\+For\+Notification()}.\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md159}{}\doxysection{\texorpdfstring{Misc Recipes on Using g\+Mock}{Misc Recipes on Using gMock}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md159}
\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md160}{}\doxysubsection{\texorpdfstring{Mocking Methods That Use Move-\/\+Only Types}{Mocking Methods That Use Move-Only Types}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md160}
...
Mocking a method that takes and/or returns move-\/only types presents some challenges, but nothing insurmountable. This recipe shows you how you can do it. Note that the support for move-\/only method arguments was only introduced to g\+Mock in April 2017; in older code, you may find more complex \doxysectlink{md_googletest_2docs_2gmock__cook__book_LegacyMoveOnly}{workarounds}{3} for lack of this feature.
...
\begin{DoxyCode}{0}
\DoxyCodeLine{using\ ::testing::IsNull;}
\DoxyCodeLine{...}
...
\DoxyCodeLine{\ \ EXPECT\_THAT(mock\_buzzer\_.MakeBuzz(\textcolor{stringliteral}{"{}hello"{}}),\ IsNull());}

\end{DoxyCode}


If you are not happy with the default action, you can tweak it as usual; see \doxysectlink{md_googletest_2docs_2gmock__cheat__sheet_OnCall}{Setting Default Actions}{1}.
...
\begin{DoxyCode}{0}
\DoxyCodeLine{EXPECT\_CALL(mock\_buzzer\_,\ MakeBuzz(\textcolor{stringliteral}{"{}hello"{}}))}
\DoxyCodeLine{\ \ \ \ .WillOnce(Return(std::make\_unique<Buzz>(AccessLevel::kInternal)));}
\DoxyCodeLine{EXPECT\_NE(\textcolor{keyword}{nullptr},\ mock\_buzzer\_.MakeBuzz(\textcolor{stringliteral}{"{}hello"{}}));}
...
\DoxyCodeLine{EXPECT\_TRUE(mock\_buzzer\_.ShareBuzz(std::make\_unique<Buzz>(AccessLevel::kInternal)),}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ 0);}
\DoxyCodeLine{}
...
A few actions (e.\+g. {\ttfamily Do\+All}) copy their arguments internally, so they can never work with non-\/copyable objects; you\textquotesingle{}ll have to use functors instead.\hypertarget{md_googletest_2docs_2gmock__cook__book_LegacyMoveOnly}{}\doxysubsubsection{\texorpdfstring{Legacy workarounds for move-\/only types}{Legacy workarounds for move-only types}}\label{md_googletest_2docs_2gmock__cook__book_LegacyMoveOnly}
...
\DoxyCodeLine{mock\_buzzer\_.ShareBuzz(std::make\_unique<Buzz>(AccessLevel::kInternal),\ 0);}

\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md161}{}\doxysubsection{\texorpdfstring{Making the Compilation Faster}{Making the Compilation Faster}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md161}
...
\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md162}{}\doxysubsection{\texorpdfstring{Forcing a Verification}{Forcing a Verification}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md162}
...
(If the name {\ttfamily Die()} clashes with an existing symbol, choose another name.) Now, we have translated the problem of testing when a {\ttfamily \doxylink{classMockFoo}{Mock\+Foo}} object dies to testing when its {\ttfamily Die()} method is called\+:
...
And that\textquotesingle{}s that.\hypertarget{md_googletest_2docs_2gmock__cook__book_UsingThreads}{}\doxysubsection{\texorpdfstring{Using g\+Mock and Threads}{Using gMock and Threads}}\label{md_googletest_2docs_2gmock__cook__book_UsingThreads}
...
Also, remember that {\ttfamily Default\+Value\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} is a global resource that potentially affects {\itshape all} living mock objects in your program. Naturally, you won\textquotesingle{}t want to mess with it from multiple threads or when there still are mocks in action.\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md164}{}\doxysubsection{\texorpdfstring{Controlling How Much Information g\+Mock Prints}{Controlling How Much Information gMock Prints}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md164}
...
Now, judiciously use the right flag to enable g\+Mock serve you better!\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md165}{}\doxysubsection{\texorpdfstring{Gaining Super Vision into Mock Calls}{Gaining Super Vision into Mock Calls}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md165}
...
If you are interested in the mock call trace but not the stack traces, you can combine {\ttfamily -\/-\/gmock\+\_\+verbose=info} with {\ttfamily -\/-\/gtest\+\_\+stack\+\_\+trace\+\_\+depth=0} on the test command line.\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md166}{}\doxysubsection{\texorpdfstring{Running Tests in Emacs}{Running Tests in Emacs}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md166}
...
Then you can type {\ttfamily M-\/m} to start a build (if you want to run the test as well, just make sure {\ttfamily foo\+\_\+test.\+run} or {\ttfamily runtests} is in the build command you supply after typing {\ttfamily M-\/m}), or {\ttfamily M-\/up}/{\ttfamily M-\/down} to move back and forth between errors.\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md167}{}\doxysection{\texorpdfstring{Extending g\+Mock}{Extending gMock}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md167}
\hypertarget{md_googletest_2docs_2gmock__cook__book_NewMatchers}{}\doxysubsection{\texorpdfstring{Writing New Matchers Quickly}{Writing New Matchers Quickly}}\label{md_googletest_2docs_2gmock__cook__book_NewMatchers}
\{\+: .callout .warning\} WARNING\+: g\+Mock does not guarantee when or how many times a matcher will be invoked. Therefore, all matchers must be functionally pure. See \doxysectlink{md_googletest_2docs_2gmock__cook__book_PureMatchers}{this section}{2} for more details.
...
For convenience, we allow the description string to be empty ({\ttfamily "{}"{}}), in which case g\+Mock will use the sequence of words in the matcher name as the description.\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md168}{}\doxysubsubsection{\texorpdfstring{Basic Example}{Basic Example}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md168}
...
where the descriptions {\ttfamily "{}is divisible by 7"{}} and {\ttfamily "{}not (is divisible by 7)"{}} are automatically calculated from the matcher name {\ttfamily Is\+Divisible\+By7}.\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md169}{}\doxysubsubsection{\texorpdfstring{Adding Custom Failure Messages}{Adding Custom Failure Messages}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md169}
...
\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md170}{}\doxysubsubsection{\texorpdfstring{Using EXPECT\+\_\+ Statements in Matchers}{Using EXPECT\_ Statements in Matchers}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md170}
You can also use {\ttfamily EXPECT\+\_\+...} statements inside custom matcher definitions. In many cases, this allows you to write your matcher more concisely while still providing an informative error message. For example\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{MATCHER(IsDivisibleBy7,\ \textcolor{stringliteral}{"{}"{}})\ \{}
\DoxyCodeLine{\ \ \textcolor{keyword}{const}\ \textcolor{keyword}{auto}\ remainder\ =\ arg\ \%\ 7;}
\DoxyCodeLine{\ \ EXPECT\_EQ(remainder,\ 0);}
\DoxyCodeLine{\ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{true};}
\DoxyCodeLine{\}}
...
If you write a test that includes the line {\ttfamily EXPECT\+\_\+\+THAT(27, Is\+Divisible\+By7());}, you will get an error something like the following\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{Expected\ equality\ of\ these\ values:}
\DoxyCodeLine{\ \ remainder}
\DoxyCodeLine{\ \ \ \ Which\ is:\ 6}
\DoxyCodeLine{\ \ 0}

\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md171}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$\+Match\+And\+Explain$<$/tt$>$}{<tt>MatchAndExplain</tt>}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md171}
You should let {\ttfamily Match\+And\+Explain()} print {\itshape any additional information} that can help a user understand the match result. Note that it should explain why the match succeeds in case of a success (unless it\textquotesingle{}s obvious) -\/ this is useful when the matcher is used inside {\ttfamily Not()}. There is no need to print the argument value itself, as g\+Mock already prints it for you.\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md172}{}\doxysubsubsection{\texorpdfstring{Argument Types}{Argument Types}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md172}
The type of the value being matched ({\ttfamily arg\+\_\+type}) is determined by the context in which you use the matcher and is supplied to you by the compiler, so you don\textquotesingle{}t need to worry about declaring it (nor can you). This allows the matcher to be polymorphic. For example, {\ttfamily Is\+Divisible\+By7()} can be used to match any type where the value of {\ttfamily (arg \% 7) == 0} can be implicitly converted to a {\ttfamily bool}. In the {\ttfamily Bar(\+Is\+Divisible\+By7())} example above, if method {\ttfamily Bar()} takes an {\ttfamily int}, {\ttfamily arg\+\_\+type} will be {\ttfamily int}; if it takes an {\ttfamily unsigned long}, {\ttfamily arg\+\_\+type} will be {\ttfamily unsigned long}; and so on.\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md173}{}\doxysubsection{\texorpdfstring{Writing New Parameterized Matchers Quickly}{Writing New Parameterized Matchers Quickly}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md173}
...
While it\textquotesingle{}s tempting to always use the {\ttfamily MATCHER\texorpdfstring{$\ast$}{*}} macros when defining a new matcher, you should also consider implementing the matcher interface directly instead (see the recipes that follow), especially if you need to use the matcher a lot. While these approaches require more work, they give you more control on the types of the value being matched and the matcher parameters, which in general leads to better compiler error messages that pay off in the long run. They also allow overloading matchers based on parameter types (as opposed to just based on the number of parameters).\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md174}{}\doxysubsection{\texorpdfstring{Writing New Monomorphic Matchers}{Writing New Monomorphic Matchers}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md174}
A matcher of type {\ttfamily \doxylink{classtesting_1_1Matcher}{testing\+::\+Matcher}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} implements the matcher interface for {\ttfamily T} and does two things\+: it tests whether a value of type {\ttfamily T} matches the matcher, and can describe what kind of values it matches. The latter ability is used for generating readable error messages when expectations are violated. Some matchers can even explain why it matches or doesn\textquotesingle{}t match a certain value, which can be helpful when the reason isn\textquotesingle{}t obvious.

Because a matcher of type {\ttfamily \doxylink{classtesting_1_1Matcher}{testing\+::\+Matcher}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} for a particular type {\ttfamily T} can only be used to match a value of type {\ttfamily T}, we call it "{}monomorphic."{}
...
\{\+: .callout .tip\} Tip\+: for convenience, {\ttfamily Match\+And\+Explain()} can take a {\ttfamily Match\+Result\+Listener\texorpdfstring{$\ast$}{*}} instead of {\ttfamily std\+::ostream\texorpdfstring{$\ast$}{*}}.\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md175}{}\doxysubsection{\texorpdfstring{Writing New Polymorphic Matchers}{Writing New Polymorphic Matchers}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md175}
Unlike a monomorphic matcher, which can only be used to match a value of a particular type, a {\itshape polymorphic} matcher is one that can be used to match values of multiple types. For example, {\ttfamily Eq(5)} is a polymorhpic matcher as it can be used to match an {\ttfamily int}, a {\ttfamily double}, a {\ttfamily float}, and so on. You should think of a polymorphic matcher as a {\itshape matcher factory} as opposed to a {\ttfamily \doxylink{classtesting_1_1Matcher}{testing\+::\+Matcher}\texorpdfstring{$<$}{<}Some\+Type\texorpdfstring{$>$}{>}} -\/ itself is not an actual matcher, but can be implicitly converted to a {\ttfamily \doxylink{classtesting_1_1Matcher}{testing\+::\+Matcher}\texorpdfstring{$<$}{<}Some\+Type\texorpdfstring{$>$}{>}} depending on the context.
...
\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md176}{}\doxysubsection{\texorpdfstring{Legacy Matcher Implementation}{Legacy Matcher Implementation}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md176}
...
Like in a monomorphic matcher, you may explain the match result by streaming additional information to the {\ttfamily listener} argument in {\ttfamily Match\+And\+Explain()}.\hypertarget{md_googletest_2docs_2gmock__cook__book_CompositeMatchers}{}\doxysubsection{\texorpdfstring{Implementing Composite Matchers}{Implementing Composite Matchers}}\label{md_googletest_2docs_2gmock__cook__book_CompositeMatchers}
Sometimes we want to define a matcher that takes other matchers as parameters. For example, {\ttfamily Distance\+From(target, m)} is a polymorphic matcher that takes a matcher {\ttfamily m} as a parameter. It tests that the distance from {\ttfamily target} to the value being matched satisfies sub-\/matcher {\ttfamily m}.

If you are implementing such a composite matcher, you\textquotesingle{}ll need to generate the description of the matcher based on the description(s) of its sub-\/matcher(s). You can see the implementation of {\ttfamily Distance\+From()} in {\ttfamily \doxylink{gmock-matchers_8h_source}{googlemock/include/gmock/gmock-\/matchers.\+h}} for an example. In particular, pay attention to {\ttfamily Distance\+From\+Matcher\+Impl}. Notice that it stores the sub-\/matcher as a {\ttfamily const Matcher\texorpdfstring{$<$}{<}const Distance\&\texorpdfstring{$>$}{>} distance\+\_\+matcher\+\_\+} instead of a polymorphic matcher -\/ this allows it to call {\ttfamily distance\+\_\+matcher\+\_\+.\+Describe\+To(os)} to describe the sub-\/matcher. If the sub-\/matcher is stored as a polymorphic matcher instead, it would not be possible to get its description as in general polymorphic matchers don\textquotesingle{}t know how to describe themselves -\/ they are matcher factories instead of actual matchers; only after being converted to {\ttfamily Matcher\texorpdfstring{$<$}{<}Some\+Type\texorpdfstring{$>$}{>}} can they be described.\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md177}{}\doxysubsection{\texorpdfstring{Writing New Cardinalities}{Writing New Cardinalities}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md177}
...
\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_QuickNewActions}{}\doxysubsection{\texorpdfstring{Writing New Actions}{Writing New Actions}}\label{md_googletest_2docs_2gmock__cook__book_QuickNewActions}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{MockFunction<int(\textcolor{keywordtype}{int})>\ mock;}
\DoxyCodeLine{EXPECT\_CALL(mock,\ Call).WillOnce([](\textcolor{keyword}{const}\ \textcolor{keywordtype}{int}\ input)\ \{\ \textcolor{keywordflow}{return}\ input\ *\ 7;\ \});}
\DoxyCodeLine{EXPECT\_EQ(mock.AsStdFunction()(2),\ 14);}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{struct\ }MultiplyBy\ \{}
\DoxyCodeLine{\ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{\ \ T\ operator()(T\ arg)\ \{\ \textcolor{keywordflow}{return}\ arg\ *\ multiplier;\ \}}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \textcolor{keywordtype}{int}\ multiplier;}
\DoxyCodeLine{\};}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{//\ Then\ use:}}
\DoxyCodeLine{\textcolor{comment}{//\ EXPECT\_CALL(...).WillOnce(MultiplyBy\{7\});}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{MockFunction<int(\textcolor{keywordtype}{int})>\ mock;}
\DoxyCodeLine{EXPECT\_CALL(mock,\ Call).WillOnce([]\ \{\ \textcolor{keywordflow}{return}\ 17;\ \});}
\DoxyCodeLine{EXPECT\_EQ(mock.AsStdFunction()(0),\ 17);}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{comment}{//\ An\ action\ that\ contains\ move-\/only\ types\ and\ has\ an\ \&\&-\/qualified\ operator,}}
\DoxyCodeLine{\textcolor{comment}{//\ demanding\ in\ the\ type\ system\ that\ it\ be\ called\ at\ most\ once.\ This\ can\ be}}
\DoxyCodeLine{\textcolor{comment}{//\ used\ with\ WillOnce,\ but\ the\ compiler\ will\ reject\ it\ if\ handed\ to}}
\DoxyCodeLine{\textcolor{comment}{//\ WillRepeatedly.}}
\DoxyCodeLine{\textcolor{keyword}{struct\ }MoveOnlyAction\ \{}
\DoxyCodeLine{\ \ std::unique\_ptr<int>\ move\_only\_state;}
\DoxyCodeLine{\ \ std::unique\_ptr<int>\ operator()()\ \&\&\ \{\ \textcolor{keywordflow}{return}\ std::move(move\_only\_state);\ \}}
\DoxyCodeLine{\};}
\DoxyCodeLine{}
...
Typically the {\ttfamily Once\+Action} and {\ttfamily Action} templates need not be referenced directly in your actions\+: a struct or class with a call operator is sufficient, as in the examples above. But fancier polymorphic actions that need to know the specific return type of the mock function can define templated conversion operators to make that possible. See {\ttfamily \doxylink{gmock-actions_8h_source}{gmock-\/actions.\+h}} for examples.\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md178}{}\doxysubsubsection{\texorpdfstring{Legacy macro-\/based Actions}{Legacy macro-based Actions}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md178}
...
\end{longtabu}
\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md179}{}\doxysubsubsection{\texorpdfstring{Legacy macro-\/based parameterized Actions}{Legacy macro-based parameterized Actions}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md179}
...
\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md180}{}\doxysubsection{\texorpdfstring{Restricting the Type of an Argument or Parameter in an ACTION}{Restricting the Type of an Argument or Parameter in an ACTION}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md180}
...
where {\ttfamily Static\+Assert\+Type\+Eq} is a compile-\/time assertion in googletest that verifies two types are the same.\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md181}{}\doxysubsection{\texorpdfstring{Writing New Action Templates Quickly}{Writing New Action Templates Quickly}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md181}
...
Are we using a single-\/template-\/parameter action where {\ttfamily bool} refers to the type of {\ttfamily x}, or a two-\/template-\/parameter action where the compiler is asked to infer the type of {\ttfamily x}?\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md182}{}\doxysubsection{\texorpdfstring{Using the ACTION Object\textquotesingle{}s Type}{Using the ACTION Object's Type}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md182}
...
Note that we have to pick different suffixes ({\ttfamily Action}, {\ttfamily ActionP}, {\ttfamily Action\+P2}, and etc) for actions with different numbers of value parameters, or the action definitions cannot be overloaded on the number of them.\hypertarget{md_googletest_2docs_2gmock__cook__book_NewMonoActions}{}\doxysubsection{\texorpdfstring{Writing New Monomorphic Actions}{Writing New Monomorphic Actions}}\label{md_googletest_2docs_2gmock__cook__book_NewMonoActions}
...
An alternative to the {\ttfamily ACTION\texorpdfstring{$\ast$}{*}} macros is to implement {\ttfamily \doxylink{classtesting_1_1ActionInterface}{testing\+::\+Action\+Interface}\texorpdfstring{$<$}{<}F\texorpdfstring{$>$}{>}}, where {\ttfamily F} is the type of the mock function in which the action will be used. For example\+:
...
\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_NewPolyActions}{}\doxysubsection{\texorpdfstring{Writing New Polymorphic Actions}{Writing New Polymorphic Actions}}\label{md_googletest_2docs_2gmock__cook__book_NewPolyActions}
...
\end{DoxyCode}
\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md183}{}\doxysubsection{\texorpdfstring{Teaching g\+Mock How to Print Your Values}{Teaching gMock How to Print Your Values}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md183}
...
This printer knows how to print built-\/in C++ types, native arrays, STL containers, and any type that supports the {\ttfamily \texorpdfstring{$<$}{<}\texorpdfstring{$<$}{<}} operator. For other types, it prints the raw bytes in the value and hopes that you the user can figure it out. \href{advanced.md\#teaching-googletest-how-to-print-your-values}{\texttt{ The Google\+Test advanced guide}} explains how to extend the printer to do a better job at printing your particular type than to dump the bytes.\hypertarget{md_googletest_2docs_2gmock__cook__book_autotoc_md184}{}\doxysection{\texorpdfstring{Useful Mocks Created Using g\+Mock}{Useful Mocks Created Using gMock}}\label{md_googletest_2docs_2gmock__cook__book_autotoc_md184}
\hypertarget{md_googletest_2docs_2gmock__cook__book_MockFunction}{}\doxysubsection{\texorpdfstring{Mock std\+::function}{Mock std::function}}\label{md_googletest_2docs_2gmock__cook__book_MockFunction}
